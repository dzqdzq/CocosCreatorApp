module.exports = {
  ...
  options: {
    ...
    landscape: "Landscape",
    portrait: "Portrait",
    tiny_packet_mode: "Small packet Mode",
    tiny_packet_path: "Resource Server Address",
    tiny_packet_path_hint: "Server address where the resource is stored",
    new: "New",
    keystore: "Keystore",
    ...
    start_scene_asset_bundle_tooltip:
