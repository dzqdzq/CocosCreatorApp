...
async function onAfterInit(i, n, r) {
  ...
  e = {
    startSceneAssetBundle: e.startSceneAssetBundle,
...
async function onBeforeBuildAssets(e, t) {
  for (var e of t.bundles) {
    if (e.isSubpackage) {
      e.dest = path_1.default.join(
        path_1.default.dirname(e.dest),
        _SUBPACKAGE_PREFIX + e.name
      );
...
async function onAfterBuild(n, r, e, t) {
  ...
  var t =
    ...
    !fs_extra_1.default.existsSync(path_1.default.join(i, "remote")) ||
      t.resourceURL ||
      console.warn(
        _get_string_i18n("options.resource_url") +
          " " +
