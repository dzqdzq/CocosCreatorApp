...
const methods = {
  ...
  async onUpdateOptions(e, t) {
    ...
    if (e) {
      ...
      t = await options_1.verificationFunc(e, t, a.options);
      a.$set(a.pkgErrorMap, e, t.error);
    }
  },
  emitChange() {
    var e = this;
...
async function getOHOSAPILevels() {
  ...
  return e && fs_1.existsSync(e) ? ["4", "5"] : [];
}
exports.$ = { root: ".ohos" };
...
exports.buttonConfig = {
  configs: {
    make: { label: "i18n:ohos.make.label", hookHandle: "make" },
    run: { label: "i18n:ohos.run.label", hookHandle: "run" },
  },
};
