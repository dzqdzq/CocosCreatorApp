...
exports.configs = {
  "web-desktop": {
    ...
    options: {
      remoteServerAddress: {
        label: "i18n:web-desktop.options.remote_server_address",
        description: "i18n:web-desktop.tips.remote_server_address",
        render: {
          ui: "ui-input",
          attributes: {
            placeholder: "i18n:web-desktop.tips.remote_server_address",
          },
        },
        verifyRules: ["http"],
      },
      ...
      polyfills: {
        ...
        itemConfigs: {
          asyncFunctions: {
            label: "i18n:web-desktop.options.async_functions",
            description: "i18n:web-desktop.options.async_functions_tips",
