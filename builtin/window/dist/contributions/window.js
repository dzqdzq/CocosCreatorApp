...
<div class="window">
    ...
    `,$:{window:".window"},async ready(){(vm=new Vue({el:this.$.window,data:{zoomLevel:0},methods:{onZoomLevelChange(e){Editor.Message.send("window","window-zoom-level-change",e)}}})).zoomLevel=await Editor.Windows.__protected__.getDefaultZoomLevel()},close(){null!==vm&&void 0!==vm&&vm.$destroy(),vm=void 0}});