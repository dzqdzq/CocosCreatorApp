"use strict";module.exports={title:"Preferences",description:"Editor preferences panel, which stores some editor global configuration and some extensions global configuration.",saving:"Saving",nav:{general:"General",laboratory:"Laboratory"},general:{language:"Language",step:"Number Step",step_tips:"Set the stepping interval when clicking up and down spinner button of ui-num-input element.",theme:"Theme",wheel_enable:"Enable Scroll Wheel Value Control",wheel_enable_tips:"In input mode for numerical input boxes, you can use the mouse scroll wheel to modify the value.",themeColor:"Theme Color ",preview_ip:"Preview IP",server_port:"Preview server port number",serverPortHelpTips:"Save the setting to project to be able to distinguish between the server port of different projects"},laboratory:{about:`
