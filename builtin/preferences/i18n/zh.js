"use strict";module.exports={title:"偏好设置",description:"编辑器偏好设置面板，这里存放一些编辑器全局配置以及插件全局配置。",saving:"正在保存",nav:{general:"通用设置",laboratory:"实验室"},general:{language:"编辑器语言",step:"数值默认步长",step_tips:"设置默认数值输入框中快捷点击加减的增减量",wheel_enable:"启用滚轮数值调节",wheel_enable_tips:"在数值输入框的输入模式下，可使用鼠标滚轮修改数值",theme:"皮肤主题",themeColor:"配色主题",preview_ip:"选择本机预览 IP 地址",server_port:"预览服务器端口号",serverPortHelpTips:"为了区分不同项目的预览服务器端口号，配置将存储到项目"},laboratory:{about:`
