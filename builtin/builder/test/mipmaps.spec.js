...
describe('纹理压缩 mipmaps 的一些工具方法验证', () => {
    describe('getMipLevel', () => {
        it('getMipLevel 32X32 -> 5', () => {
            expect(getMipLevel(32, 32)).to.equal(5);
        });
        it('getMipLevel 32X64 -> 6', () => {
            expect(getMipLevel(32, 64)).to.equal(6);
        });
        it('getMipLevel 64X32 -> 6', () => {
            expect(getMipLevel(64, 32)).to.equal(6);
        });
    });
