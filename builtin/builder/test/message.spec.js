...
describe('构建通用消息测试', () => {
    ...
    // 平台构建模板已经归平台插件管理了
    // TODO Menu.queryMain 目前主进程不支持，需要等 base 支持后才能跑自动化，先注释
    ...
    //                 const templatePath = join(Editor.Project.path, 'build-templates', type in specialTemplateConfig ? specialTemplateConfig[type] : message.params[0]);
