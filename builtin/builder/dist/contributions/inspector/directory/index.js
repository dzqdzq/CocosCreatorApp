                ...
                >
                    ...
                    <div slot="content">
                        <ui-select-pro
                            ...
                            @click.stop
                        >
                            <template v-for="(config, key) in bundleConfigs">
                                <ui-select-option-pro
                                    :value="key"
                                    :key="key"
                                    :label="config.displayName"
                                    :selected="(metas[0].userData.bundleConfigID || defaultValue.bundleConfigID) === key"
                                />
                            </template>
                        </ui-select-pro>
