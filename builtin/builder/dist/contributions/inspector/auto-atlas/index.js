"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.$=exports.template=exports.style=void 0,exports.update=update,exports.close=close;const fs_extra_1=require("fs-extra"),path_1=require("path"),lodash=require("lodash"),Vue=require("vue/dist/vue.js"),PKG_NAME=(Vue.config.productionTip=!1,Vue.config.devtools=!1,exports.style=(0,fs_extra_1.readFileSync)((0,path_1.join)(__dirname,"./style.css"),"utf8"),"builder"),I18N_HEADER=`i18n:${PKG_NAME}.assets.auto_atlas`,vueTemplate=`
<section class="asset-auto-atlas">
    ...
    >
        ...
        <div class="footer">
            ...
            >
            <div class="image"
                v-for="(imageInfo, index) in packedTextures"
            >
                    <img class="img"
                        :src="imageInfo.imagePath + '?' + Math.random()"
                    >
                    <ui-link :value="imageInfo.imagePath" :tooltip="imageInfo.imagePath">
                        <ui-label value="${I18N_HEADER}.packedImage"></ui-label>
                        ({{ index + 1 }})_{{imageInfo.width}}X{{imageInfo.height}}
                    </ui-link>
                </div>
            </div>
