"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.methods=exports.computed=exports.watch=exports.name=exports.props=exports.template=void 0,exports.data=data,exports.mounted=mounted;const path_1=require("path"),plugin_1=require("../plugin"),fs_extra_1=require("fs-extra");function data(){return{buttonConfig:{buttons:[]},buildModeList:[{label:"i18n:builder.options.build_mode_normal",value:"normal"},{label:"i18n:builder.options.build_mode_bundle",value:"bundle"}]}}function mounted(){Object.keys(plugin_1.pluginManager.platformInfoMap).length&&(this.buttonConfig=this.calcBuildConfig())}exports.template=`
