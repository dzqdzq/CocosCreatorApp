...
exports.assetHandlers = undefined;
...
const complexTestItems = {
  number: {
    ...
    default: 80,
    render: { ui: "ui-num-input", attributes: { step: 1, min: 0 } },
  },
  string: {
  ...
  "*": {
    ...
    options: {
      remoteAddress: {
        ...
        render: {
          ui: "ui-input",
          attributes: { placeholder: "Enter remote address..." },
        },
      ...
      arrayTest: {
        ...
        type: "array",
        default: [
          complexTestItems.number.default,
          complexTestItems.string.default,
          complexTestItems.boolean.default,
        ],
        itemConfigs: JSON.parse(
          JSON.stringify(Object.values(complexTestItems))
        ),
      },
    },
    panel: "./panel",
