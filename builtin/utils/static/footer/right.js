...
<div class="footer-notice">
    ...
    >
        ...
        <ul class="content" ref="content">
            ...
            >
                <ui-label class="title" :value="item.title"></ui-label>
                <ui-label class="message" :value="item.message"></ui-label>
                <div class="source" 
                    v-if="item.source"
                >
                ...
                >
                    ...
                    >
                        <ui-label 
                            :value="button.label || 'i18n:utils.info.notice.default.button_name'" 
                        ></ui-label>
                    </ui-button>
                </div>
