...
const tc_binding_1 = __importDefault(require("./tc-binding"));

const binary_condition_constant_operand_1 = __importDefault(
  require("./binary-condition-constant-operand")
);
...
const conditionGrid = {
  components: {
    "tcf-binding": tc_binding_1.default,
    "binary-condition-constant-operand":
      binary_condition_constant_operand_1.default,
    "variable-selection": variable_selection_1.default,
  },
  props: ["conditions", "queryData", "keyOrRefPrefix", "transitionSourceType"],
  template,
};

exports.default = conditionGrid;
