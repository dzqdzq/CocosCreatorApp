...
class Tester extends EventEmitter {
  ...
  async run() {
    await classify_1.default.current.run();
  }
}
exports.Tester = Tester;
exports.tester = new Tester();

logger_1.logger.on("print", (e) => {
  exports.tester.emit("print", e);
});

logger_1.logger.on("rollback", () => {
  exports.tester.emit("rollback");
});

global.Tester = exports.tester;
