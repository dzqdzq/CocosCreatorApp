  ...
  messages: {
    description: {
      ...
      gameview_play_of_switch_scene:
        "当前 Game View 处于播放状态,要切换场景请退出播放。",
      open_scene: "打开场景",
      close_scene: "关闭场景",
      save_scene: "保存场景",
      save_as_scene: "场景另存为",
      ...
      scene_close: "场景关闭通知",
      UITransform_lack:
        "正在添加 UI 节点，但所有上层节点都没有 cc.UITransform 组件",
      ...
      animationComponentCollision:
        "动画控制器组件和动画组件、骨骼动画组件不能共存。",
      physicsDynamicBodyShape:
        "动力学刚体不能设置为以下碰撞体：Terrain, Plane, Non-Convex Mesh。",
      ...
      light_probe_delete_when_editing_probe:
        "当前正在探针编辑模式 无法修改正在编辑的探针节点。请先退出探针编辑模式并再次尝试。",
