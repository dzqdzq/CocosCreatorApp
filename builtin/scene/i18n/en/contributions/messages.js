module.exports = {
  messages: {
    description: {
      ...
      gameview_play_of_switch_scene:
        "The GameView is currently in the playing state. To switch scenes, please stop GameView.",
      ...
      move_array_element:
        "Move the position of item in the property with Array type",
      ...
      align_with_view:
        "Apply the scene camera position and Angle to the selected node",
      align_view_with_node:
        "Applies the selected node position and Angle to the current view",
      scene_ready: "Message when scene is opened",
      scene_close: "Message when scene is closed",
      UITransform_lack:
        "UI node is being added, but the cc.UITransform component is not found in any upper node",
      ...
      physicsDynamicBodyShape:
        "A dynamic rigid body can not have the following collider shapes: Terrain, Plane and Non-Convex Mesh.",
      light_probe_edit_mode_changed:
        "LightProbe edit mode changed notification",
      light_probe_bounding_box_edit_mode_changed:
        "LightProbe component bounding box edit mode changed notification",
      light_probe_delete_when_editing_probe:
        "Currently in probe editing mode The probe node being edited cannot be modified. Please exit probe editing mode and try again.",
      ...
      apply_prefab:
        "Apply modification to prefab asset(record undo automatically)",
      restore_prefab:
        "Restore prefab node form asset(record undo automatically)",
      revert_removed_component:
        "Revert removed component(record undo automatically)",
      apply_removed_component:
        "Apply removed component to prefab asset(record undo automatically)",
    },
    doc: {
      open_scene: `
