...
`;exports.ToolbarDefault=Vue.extend({name:"ToolbarDefault",components:{ToolbarPlugin:plugin_1.ToolbarPlugin},props:{left:{type:Array,default:()=>[]},right:{type:Array,default:()=>[]},scenes:{type:Array,default:()=>[{name:"scene"}]}},data(){return{}},template:template});