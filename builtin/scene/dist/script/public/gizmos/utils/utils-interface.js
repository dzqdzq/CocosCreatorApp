...
class UtilsInterface {
  ...
  baseDist = 0;
  constructor() {
    this.GizmoUtils = new misc_1.default();
    this.baseDist = 600;
  }
  requestPointerLock() {}
  exitPointerLock() {}
  ...
  clampSize(t, e = 3) {
    ...
    t.y = Math.abs(t.y);
    t.z = Math.abs(t.z);
    t.x = MathUtil.toPrecision(t.x, e);
    t.y = MathUtil.toPrecision(t.y, e);
    t.z = MathUtil.toPrecision(t.z, e);
  }
  select(t) {}
  changePointer(t) {}
}
exports.default = UtilsInterface;
