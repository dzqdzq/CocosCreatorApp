...
class SphereController extends editable_1.default {
  ...
  setColor(i) {
    Object.keys(this._circleDataMap).forEach((e) => {
      var e = this._circleDataMap[e];

      setMeshColor(e.frontArcMR.node, i);
      var t = getNodeOpacity(e.backArcMR.node);

      var r = i.clone();
      r.a = t;
      setMeshColor(e.backArcMR.node, r);
    });

    setMeshColor(this._borderCircle, i);
    this.setEditHandlesColor(i);
    this._color = i;
  }
  createCircleByAxis(e, t, r) {
    var i = axisDirMap[e];
    var t = axisDirMap[t];

    var a = controller_utils_1.default.arc(
      this._center,
      i,
      t,
      2 * Math.PI,
    ...
    a.name = "arc_" + e + "_front";
    a.parent = this.shape;

    var r = controller_utils_1.default.arc(
      this._center,
      i,
      t,
      2 * Math.PI,
    ...
    s.frontArcMR = getModel(a);
    s.backArcMR = getModel(r);
    s.normalDir = i;
    s.fromDir = t;
    this._circleDataMap[e] = s;
  }
  createBorderCircle() {
    this._borderCircle = controller_utils_1.default.circle(
      this._center,
      new cc_1.Vec3(0, 0, 1),
      this._radius,
      this._color
  ...
  _updateEditHandle(e) {
    ...
    var e = axisDirMap[e];
    var r = new cc_1.Vec3();
    var e = (cc_1.Vec3.multiplyScalar(r, e, this._radius), new cc_1.Vec3(r));
    e.add(this._center);
  ...
  updateShape() {
    ...
    var e = NodeUtils.getWorldPosition3D(e);
    var t = new cc_1.Mat4();
    this.shape.getWorldMatrix(t);
    cc.Mat4.invert(t, t);
    cc_1.Vec3.transformMat4(e, e, t);
    const c = tempVec3_b;
    cc_1.Vec3.subtract(c, this._center, e);
    var r;
    var t = cc_1.Vec3.lengthSqr(c);
    var e = this._radius * this._radius;
    const l = (e * e) / t;
    const _ = l / e;
    ...
    if (_ < 1) {
      ...
      r = Math.sqrt(e - l);
      e = cc_1.Vec3.multiplyScalar(tempVec3_a, c, e / t);
      t = cc_1.Vec3.subtract(tempVec3_a, this._center, e);
      e = controller_shape_1.default.calcCirclePoints(t, c, r);
      updatePositions(this._borderCircelMR, e);
    } else {
    ...
    Object.keys(this._circleDataMap).forEach((e) => {
      ...
      var r;
      var i;
      var a = this._circleDataMap[e].normalDir;
      var s = this._circleDataMap[e].frontArcMR;
      var o = this._circleDataMap[e].backArcMR;

      if (
        _ < 1 &&
        ((t = controller_utils_1.default.angle(c, a)),
        (t = 90 - Math.min(t, 180 - t)),
        (t = Math.tan(t * EditorMath.D2R)),
        (t = Math.sqrt(l + t * t * l) / this._radius) < 1)
      ) {
        t = Math.asin(t);
        cc_1.Vec3.cross(tempVec3_a, a, c);
        (r = tempVec3_a).normalize();
        i = tempQuat_a;
        cc_1.Quat.fromAxisAngle(i, a, t);
        cc_1.Vec3.transformQuat(r, r, i);
        ...
        this.updateArcMesh(
          ...
          a,
          r,
          2 * (EditorMath.HALF_PI - t) - EditorMath.TWO_PI,
          this._radius
        );
      } else {
        this.updateArcMesh(
  ...
  updateArcMesh(e, t, r, i, a, s) {
    t = controller_shape_1.default.calcArcPoints(t, r, i, a, s);
    updatePositions(e, t);
  }
  onEditorCameraMoved() {
    this.updateShape();
