...
const controller_cylinder_1 = __importDefault(require("./controller-cylinder"));
const NodeUtils = external_1.default.NodeUtils;
const EditorMath = external_1.default.EditorMath;
const tempQuat_a = new cc_1.Quat();
class CylinderColliderComponentGizmo extends base_1.SelectGizmo {
  _controller;
  _maxScale = 1;
  _radius = 0;
  _height = 0;
  ...
  createController() {
    ...
    this._controller = new controller_cylinder_1.default(t);
  ...
  updateControllerData() {
    ...
    if (this._isInitialized && this.target !== null) {
      if (this.target instanceof cc_1.CylinderCollider) {
        ...
        this._controller.hide();
        console.error("target is not a cc.CylinderCollider");
      }
    }
  }
  onTargetUpdate() {
...
exports.default = CylinderColliderComponentGizmo;
