...
const setMeshColor = engine_1.default.setMeshColor;
class DirectionLightController extends base_1.default {
  ...
  setColor(e) {
    setMeshColor(this._lightDirNode, e);
    this._color = e;
  }
  initShape() {
    this.createShapeNode("DirectionLightController");
    var e = new cc_1.Vec3(0, 0, -1);

    var e = controller_utils_1.default.arcDirectionLine(
      new cc_1.Vec3(),
      e,
      new cc_1.Vec3(1, 0, 0),
      this._twoPI,
    ...
    e.parent = this.shape;
    this._lightDirNode = e;
    this.hide();
  }
}
exports.default = DirectionLightController;
