...
class BoxCollider2DGizmo extends base_1.SelectGizmo {
  _controller;
  _size = new cc_1.Size();
  ...
  onControllerMouseMove() {
    ...
    if (this._controller.updated) {
      ...
      e = this._controller.getDeltaSize();

      t === HandleType.Area
        ? this.handleAreaMove(e)
        : ((o = this._altKey), this.handleTargetSize(t, e, o));
    }
  }
  onControllerMouseUp() {
  ...
  handleAreaMove(t) {
    ...
    if (this.target) {
      ...
      NodeUtils.makeVec2InPrecision(tempVec2, 1);
      this.target.offset.set(tempVec2);
      this.onComponentChanged(e);
    }
  }
  modifyPosDeltaWithAnchor(t, e, o, r, l) {
    if (
      t === HandleType.Right ||
      t === HandleType.TopRight ||
      t === HandleType.BottomRight
    ) {
      l && (o.x /= 1 - r.x);
      e.x = o.x * r.x;
    } else {
  ...
  handleTargetSize(t, e, o) {
    var r = e.clone();
    var e = new cc_1.Vec2(e.x, e.y);
    e.x = EditorMath.toPrecision(e.x, 3);
    e.y = EditorMath.toPrecision(e.y, 3);
    this.modifyPosDeltaWithAnchor(t, r, e, this._anchor, o);

    if (this.target) {
      (t = this.target.node).getWorldMatrix(tempMat4);
      cc_1.Mat4.invert(tempMat4, tempMat4);
      tempMat4.m12 = tempMat4.m13 = 0;
      cc_1.Vec3.transformMat4(r, r, tempMat4);

      o ||
        ((o = tempQuat_a),
        t.getRotation(o),
        cc_1.Vec3.transformQuat(r, r, o),
        (r.z = 0),
        tempVec2.set(this._offset),
        tempVec2.add2f(r.x, r.y),
        NodeUtils.makeVec2InPrecision(tempVec2, 1),
        this.target.offset.set(tempVec2));
      ...
      e.x = e.x / o.x;
      e.y = e.y / o.y;
      r = this._size.width + e.x;
      o = this._size.height + e.y;
      r = EditorMath.toPrecision(r, 1);
      o = EditorMath.toPrecision(o, 1);
      this.target.size.set(cc.size(r, o));
  ...
  updateControllerData() {
    ...
    if (this._isInitialized && this.target !== null) {
      if ((t = this.target)) {
        (e = t.node) && e.getWorldMatrix(tempMat4);
        o = t.size;
        l = t.offset;
        r = cc.v3();
        r.x = l.x;
        r.y = l.y;
        l = NodeUtils.getWorldScale3D(e);
        cc_1.Vec3.transformMat4(r, r, tempMat4);
        i = tempQuat_a;
        NodeUtils.getWorldRotation3D(e, i);
        this._controller.setPosition(r);
        this._controller.setRotation(i);

        this._controller.updateSize(
          cc_1.Vec3.ZERO,
          cc.v2(o.width * l.x, o.height * l.y)
        );
...
exports.default = BoxCollider2DGizmo;
