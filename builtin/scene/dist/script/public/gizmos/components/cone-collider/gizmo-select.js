...
class ConeColliderComponentGizmo extends base_1.SelectGizmo {
  _controller;
  _maxScale = 1;
  _radius = 0;
  _height = 0;
  ...
  createController() {
    ...
    this._controller = new cone_1.default(t);
  ...
  updateControllerData() {
    ...
    if (this._isInitialized && this.target !== null) {
      if (this.target instanceof cc_1.ConeCollider) {
        ...
        this._controller.hide();
        console.error("target is not a cc.ConeCollider");
      }
    }
  }
  onTargetUpdate() {
...
exports.default = ConeColliderComponentGizmo;
