"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const utils_1=require("../utils"),dum_element_base_1=require("../dum-element-base");class Vec4 extends dum_element_base_1.DumpElementBase{constructor(){super(...arguments),this.type=["cc.Vec4","cc.Quat"],this.$x=null,this.$y=null,this.$z=null,this.$w=null,this._listeners=["change"],this.template=`
