"use strict";var __createBinding=this&&this.__createBinding||(Object.create?function(e,i,l,n){void 0===n&&(n=l);var a=Object.getOwnPropertyDescriptor(i,l);a&&("get"in a?i.__esModule:!a.writable&&!a.configurable)||(a={enumerable:!0,get:function(){return i[l]}}),Object.defineProperty(e,n,a)}:function(e,i,l,n){e[n=void 0===n?l:n]=i[l]}),__setModuleDefault=this&&this.__setModuleDefault||(Object.create?function(e,i){Object.defineProperty(e,"default",{enumerable:!0,value:i})}:function(e,i){e.default=i}),__importStar=this&&this.__importStar||function(){var a=function(e){return(a=Object.getOwnPropertyNames||function(e){var i,l=[];for(i in e)Object.prototype.hasOwnProperty.call(e,i)&&(l[l.length]=i);return l})(e)};return function(e){if(e&&e.__esModule)return e;var i={};if(null!=e)for(var l=a(e),n=0;n<l.length;n++)"default"!==l[n]&&__createBinding(i,e,l[n]);return __setModuleDefault(i,e),i}}();Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=exports.methods=exports.$=exports.template=exports.position=void 0,exports.ready=ready,exports.close=close;const debug_view_component_1=require("./debug-view-component"),Vue=require("vue/dist/vue.js");Vue.config.productionTip=!1,Vue.config.devtools=!1;let $scene=null,panel=null,vm=null;const vueTemplate=`
