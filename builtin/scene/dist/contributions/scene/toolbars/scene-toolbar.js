...
<div class="scene-toolbar">
    <div class="scene-gizmo-buttons">
        <ui-button type="icon" class="view transparent" tooltip="i18n:scene.tooltips.view_gizmo">
            <ui-icon value="gizmo-select"></ui-icon>
        </ui-button>
