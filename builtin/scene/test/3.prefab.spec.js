...
describe('Prefab操作测试', () => {
    ...
    describe('prepare test resources', async () => {
        ...
        it('revert remove component in prefabInstance', async () => {
            ...
            const firstChildDump = await Editor.Message.request('scene', 'query-node', firstChild.uuid);
        ...
        it('create prefabInstance 2', async () => {
            ...
            const nodeDump = await Editor.Message.request('scene', 'query-node', testNodeUUID2);
