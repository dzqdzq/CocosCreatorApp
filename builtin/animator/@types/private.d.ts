...
export type IAnimationType = 'cc.Animation' | 'cc.SkeletalAnimation';
...
export interface aniVmData {
    ...
    clipsMenu: Array<{ uuid: string; name: string }>; // clip 菜单
...
export interface IAniVMMethods {
    ...
    t: (key: string, type?: string) => string;
