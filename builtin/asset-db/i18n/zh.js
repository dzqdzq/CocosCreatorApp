"use strict";module.exports={title:"资源数据库",description:"Cocos Creator 资源管理器",deprecatedTip:"{oldName} 已在 {version} 版本废弃，请更换为 {newName}",globalReadonlyTip:"全局变量 {name} 字段已被资源进程使用，不可重写，请更换其他字段",mask:{startup:"正在启动资源数据库 - {name}",loading:"正在启动中"},"debug-mode":"打开资源(构建)调试工具",assetDBPauseTips:"资源数据库已锁定，资源操作({operate})将会延迟响应，请稍侯",assetDBInitError:"资源进程启动失败！",operate:{dialogError:"错误",dialogWarning:"警告",dialogQuestion:"确认",dialogInfo:"提示",dialogDoNotNotify:"本次操作不再提醒",overwrite:"覆盖",rename:"重命名",edit:"编辑",editTip:"启动中...",apply:"应用",cancel:"取消",stillOpen:"仍要打开"},operation:{invalid_url:"无效的 URL: 传入 URL 必须是字符串, 且以 db:// 开头",exists_url:"无效的 URL: URL 指向资源不存在",readonly:"目标路径不合法: 目标为只读文件夹",overwrite:"文件已存在，是否覆盖？"},importAsset:{metaExists:"{name} 资源 meta 文件已存在，跳过 meta 导入，如果需要请在偏好设置内开启"},openAsset:{preferenceProgramWarning:"为更好地打开脚本，请在 {preferences} -> {program} -> {scriptEditor} 里配置打开脚本的应用程序",fail:{noAsset:"打开资源失败：无法找到资源"}},createAsset:{title:"创建资源",fail:{unknown:"创建资源 ({target}) 失败: 未知错误",type:"创建资源失败: 传入的资源类型 ({type}) 无法识别",url:"创建资源失败: 传入的地址 ({url}) 无法识别",exist:"创建资源失败: 文件已经存在",drop:"创建资源失败: 导入的资源地址 ({target}) 不存在",toUrl:"创建资源失败: 文件路径 ({target}) 可能超出项目范围，无法转为项目内的 URL",uuid:"创建资源失败: 无法转换为项目 URL 的参数 ({target})",content:"创建资源 ({target}) 失败: 文件内容格式不正确",readonly:"创建资源 ({target}) 失败: 不能在只读资源上操作"},warn:{overwrite:"文件已存在，是否覆盖？"}},createAssetTemplate:{title:"创建资源模板",manageTemplate:"管理模板文件"},dropAsset:{overwrite:"覆盖文件",reserve:"保留两个文件",fail:{unknown:"导入资源失败: 未知错误",url:"导入资源失败: 目标地址格式错误，须为 db://folder 格式",filepaths:"导入资源失败: 被导入的资源不能为空",readonly:"导入资源失败: 不能在只读资源上导入"},warn:{overwrite:"文件已存在，是否覆盖？",sameway:"接下来的导入保持相同操作"}},saveAsset:{fail:{unknown:"保存资源失败: 未知错误",uuid:"保存资源失败: 无法识别 UUID ",asset:"保存资源失败: 找不到资源 {asset}",content:"保存资源失败: 文件内容格式不正确 ",readonly:"保存资源失败: 不能在只读资源上操作"}},saveAssetMeta:{fail:{unknown:"保存资源 META 失败: 未知错误",uuid:"保存资源 META 失败: 无法识别 UUID ",content:"保存资源 META 失败: 文件内容格式不正确 ",readonly:"保存资源 META 失败: 不能在只读资源上操作"}},copyAsset:{fail:{unknown:"复制资源失败: 未知错误",url:"复制资源失败: 参数不合法 ",source:"复制资源失败: 源地址不存在文件",target:"复制资源失败: 目标文件已经存在",include:"复制资源失败: 源地址不能被目标地址包含",parent:"复制资源失败: 目标地址的父级地址不正确",readonly:"复制资源失败: 目标地址的父级地址是只读文件，不可粘贴进子文件",metauuid:"复制资源失败: 写入新的 uuid 发生错误"}},moveAsset:{fail:{unknown:"移动资源失败: 未知错误",url:"移动资源失败: 参数不合法 ",source:"移动资源失败: 源地址不存在文件",target:"移动资源失败: 目标地址不合法",exist:"移动资源失败: 目标地址已经存在相同的文件",include:"移动资源失败: 源地址不能被目标地址包含",parent:"移动资源失败: 目标地址的父级地址不正确",readonly_source:"移动资源失败: 源地址是只读文件，不可移动",readonly:"移动资源失败: 目标地址的父级地址是只读文件，不可移入子文件"},warn:{overwrite:"文件已存在，是否覆盖？"}},renameAsset:{fail:{source:"复制资源失败: 源地址不存在文件",include:"复制资源失败: 源地址不能被目标地址包含",parent:"复制资源失败: 目标地址的父级地址不正确"},warn:{overwrite:"文件已存在，是否覆盖？"}},deleteAsset:{fail:{unknown:"删除资源失败: 未知错误",url:"删除资源失败: 参数不合法 ",unexist:"删除资源失败: 文件不存在 ",readonly:"删除资源失败: 只读文件不可删除"}},preferences:{log_level:"日志等级",log_level_debug:"输出所有信息",log_level_log:"输出错误、警告以及日志",log_level_warn:"仅输出错误、警告",log_level_error:"仅输出错误",ignore_glob:"忽略文件（采用 Glob 匹配模式）",ignore_glob_tips:"多个范围用逗号分隔",ignore_changed:"忽略配置修改",notice_reload_editor:"需要重启编辑器使用新的配置",auto_scan:"自动刷新资源",auto_scan_info:"关闭自动刷新后，编辑器将不检查外部资源更新，如果需要更新资源状态，请点击资源面板上的刷新按钮。",autoOverwriteMeta:"导入资源时自动覆盖 meta",autoOverwriteMetaTooltip:"当导入的资源存在 meta 且与本地资源冲突的时候，自动覆盖",flagReimportCheck:"优化调度策略",flagReimportCheckTooltip:"使用策略优化导入过程，减少开销",globalInternalLibrary:"内置资源导入到全局目录",globalInternalLibraryTooltip:"将引擎自带的内置资源导入到全局目录全项目共享避免重复导入，可加快编辑器启动速度，将会影响到内置资源导入后的 library 位置",defaultImageMeta:"图片默认导入类型",defaultMeta:"资源默认导入配置",defaultMetaTip:"此配置允许用户自定义新增时默认的一些导入配置，更改后，项目内新添加的资源将按照新的配置导入，已经存在项目中的资源仍将维持原有类型。",prefabPreview:"预制体资源预览",prefabPreviewTooltip:"开启预制体资源预览，选择预制体资源时，属性检查器中会预览预制体内部。",restoreAssetDBFromCache:"启动编辑器时从缓存中恢复资源数据库",restoreAssetDBFromCacheTooltip:"启动编辑器时将从缓存中恢复资源数据库以加快启动速度，如需刷新资源可点击资源管理器的刷新按钮或者重新聚焦编辑器触发自动刷新"},restoreAssetDBFromCacheInValid:{upgrade:"项目升级过程中，资源启动复用缓存机制无效",noLibraryPath:"library 文件夹不存在，资源启动复用缓存机制无效"},importers:{image:{title:"是否转换图片格式？",change_type_detail:"是否将 {name} 依赖的 {path} 图片资源转成符合 {name} 使用的 'SpriteFrame' 类型"}},contributions:{messages:{description:{asset_db_ready:"资源数据库准备就绪时的广播",asset_db_close:"资源数据库关闭时的广播",asset_db_asset_add:"当资源数据库准备就绪后，再新增资源时的广播",asset_db_asset_change:"当一个资源被修改时的广播",asset_db_asset_delete:"当一个资源被删除时的广播",query_ready:"检查资源数据库是否启动完毕",create_asset:"新建一个资源",import_asset:"将一个文件或文件夹导入到资源数据库内",copy_asset:"复制某个资源",move_asset:"将一个资源移动到某个地方",rename_asset:"重命名指定资源",delete_asset:"删除一个资源",open_asset:"尝试使用记录的打开程序打开一个资源",save_asset:"保存资源",save_asset_meta:"保存资源的 meta 信息",reimport_asset:"重新导入资源",refresh_asset:"刷新一个资源所在的 url 位置，删除资源会被销毁，新增资源会导入",query_path:"查询一个资源的路径",query_url:"查询一个资源的 URL",query_uuid:"查询一个资源的 UUID",query_assets:"根据条件查询资源数组",query_asset_info:"查询一个资源的基本信息",query_asset_meta:"查询一个资源的 META 信息",generate_available_url:"根据传入的 url 生成一个可用的新 url",query_asset_users:"查询一个资源被哪些资源或脚本直接使用到",query_asset_dependencies:"查询一个资源依赖的资源或脚本 uuid 数组"},doc:{asset_db_asset_add:"",query_ready:"@returns {boolean} 是否准备就绪",create_asset:`
