...
const rollup_plugin_node_resolve_1 = __importDefault(require("@cocos/rollup-plugin-node-resolve"));
exports.nodeResolve = rollup_plugin_node_resolve_1.default;
...
const rollup_plugin_terser_1 = __importDefault(require("@cocos/rollup-plugin-terser"));
