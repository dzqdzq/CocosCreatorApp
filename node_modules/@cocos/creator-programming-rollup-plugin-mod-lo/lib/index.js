...
function $({ modLo, origin, }) {
    ...
    const loadMetaMap = {};
    const originURL = origin !== null && origin !== void 0 ? origin : url_1.pathToFileURL(path_1.default.join(process.cwd(), path_1.default.sep));
    return {
        name: myName,
        resolveId,
        load,
    ...
    async function resolveId(source, importer, _options) {
        ...
        try {
            ...
            if (specifier_1.isBareSpecifier(source) && importerModLoType === 'commonjs') {
                return {
