...
export declare class ModLo {
    constructor({ transformer: transformerType, targets, exportsConditions, loose, useDefineForClassFields, allowDeclareFields, guessCommonJsExports, _importMetaURLValid, _helperModule, cr, _compressUUID, transformExcludes: transformExcludes, logger, _internalTransform, }: ModLoOptions);
