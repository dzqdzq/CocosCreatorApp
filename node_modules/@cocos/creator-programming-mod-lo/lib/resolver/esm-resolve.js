...
asserts_1.asserts(Object.values(pkgTargetPriority).every(key => key <= pkgTargetPriority['default']), 'The priority of condition export should be less-equal to default.');
