 ...
 */
class ModLo {
    constructor({ transformer: transformerType = 'babel', targets, exportsConditions, loose = false, useDefineForClassFields = true, allowDeclareFields = true, guessCommonJsExports = false, _importMetaURLValid = true, _helperModule = '', cr, _compressUUID, transformExcludes: transformExcludes, logger, _internalTransform, }) {
...
class AccessDeniedError extends Error {
    constructor(url) {
        super((0, i18n_1.i18nTranslate)('modLo_access_denied_error', { url }));
    }
}
...
function getCjsInteropTarget(url) {
    ...
    if (originalExtension) {
        ...
        (0, url_2.replaceExtension)(target, originalExtension);
    }
    return target;
}
