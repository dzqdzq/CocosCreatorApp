...
class StatsQuery {
    ...
    evaluateModuleOverrides(context) {
        var _a;
        const overrides = {};
        const addModuleOverrides = (moduleOverrides) => {
            for (const [source, override] of Object.entries(moduleOverrides)) {
                const normalizedSource = path_1.default.resolve(this._engine, source);
                const normalizedOverride = path_1.default.resolve(this._engine, override);
                overrides[normalizedSource] = normalizedOverride;
            }
        };
        (_a = this._config.moduleOverrides) === null || _a === void 0 ? void 0 : _a.forEach(({ test, overrides }) => {
