...
const interface_filter_1 = require("./interface-filter");
const DEBUG = false;
...
async function build(options) {
    ...
    let code = fs_extra_1.default.readFileSync(tscOutputDtsFile, 'utf8');
    ...
    if (matches) {
        ...
        fs_extra_1.default.outputFileSync(tscOutputDtsFile, outputUnbundledCode, 'utf8');
    }
    ...
    try {
        ...
        interface_filter_1.interfaceFilter.cullInterface({
