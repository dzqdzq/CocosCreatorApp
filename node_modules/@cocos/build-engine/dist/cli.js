...
async function main() {
    ...
    yargs_1.default.option('build-mode', {
        type: 'string',
        alias: 'b',
        description: `Target build-mode. Predefined values: [${build_time_constants_1.getBuildModeConstantNames().join(',')}]`,
    });
    yargs_1.default.option('platform', {
        type: 'string',
        alias: 'p',
        description: `Target platform. Predefined values: [${build_time_constants_1.getPlatformConstantNames().join(',')}]`,
        demandOption: true,
    });
    ...
    yargs_1.default.option('module', {
        choices: index_1.enumerateModuleOptionReps(),
    ...
    const options = {
        engine: yargs_1.default.argv.engine,
    ...
    if (yargs_1.default.argv.module) {
        options.moduleFormat = index_1.parseModuleOption(yargs_1.default.argv['module']);
    }
    ...
    const result = await index_1.build(options);
