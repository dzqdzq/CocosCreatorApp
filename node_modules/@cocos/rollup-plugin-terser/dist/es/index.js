...
import { isObject, merge, hasOwnProperty } from 'smob';
...
function terser(input = {}) {
    ...
    let worker;
    let numOfChunks = 0;
    const currentScriptURL = typeof __filename !== 'undefined' ? pathToFileURL(__filename) : import.meta.url;
    return {
        name: 'terser',
...
export { terser as default, runWorker, transform };
