...
exports.pluginDecoratorCC = (0, helper_plugin_utils_1.declare)((api, options) => {
    api.assertVersion(7);
    ...
    return {
        ...
        pre(file) {
            if (options.helpers === 'external') {
                ...
                file.set(constants_1.CC_HELPER_IMPORT_GENERATOR, (name) => {
                    ...
                    return importHelperCache[name] = (0, helper_module_imports_1.addNamed)(file.path, name, helpers_1.CC_HELPER_MODULE);
                });
            }
            const helperCache = {};
            // @ts-ignore get should have been defined in BabelFile
            file.set(constants_1.CC_HELPER_GENERATOR, (name) => {
                ...
                const helperBuilder = (0, helpers_1.getHelperBuilder)(name);
        ...
        visitor: (0, legacy_visitor_1.genVisitor)(options.fieldDecorators, options.editorDecorators),
        post(file) {
            // @ts-ignore get should have been defined in BabelFile
