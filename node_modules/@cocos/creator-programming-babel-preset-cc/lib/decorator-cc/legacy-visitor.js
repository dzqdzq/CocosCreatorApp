...
function genVisitor(fieldDecorators, editorDecorators) {
  ...
  `);
    const buildClassPrototype = (0, core_1.template)(`
  CLASS_REF.prototype;
  `);
    const buildGetDescriptor = (0, core_1.template)(`
    Object.getOwnPropertyDescriptor(TARGET, PROPERTY);
  `);
    const buildGetObjectInitializer = (0, core_1.template)(`
        ...
        const exprs = decoratedProps.reduce(function (acc, node) {
            ...
            if (core_1.types.isClassProperty(node, { static: false })) {
                if (FIELD_NODES.has(node)) {
                    ...
                    acc.push(
                    // @ts-ignore
                    core_1.types.assignmentExpression("=", core_1.types.cloneNode(initializerIdentifier), core_1.types.callExpression((0, helpers_1.addHelper)(state, 'applyDecoratedInitializer'), [
