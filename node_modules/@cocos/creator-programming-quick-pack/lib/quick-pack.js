...
class QuickPack {
    ...
    async _inspect(url, mTimestamp) {
        ...
        try {
            ...
            this._logger.error((0, i18n_1.i18nTranslate)('quick_pack_failed_to_load', { url: url.href, cause: err }));
            if (url.protocol === 'node:') {
                this._logger.warn((0, i18n_1.i18nTranslate)('load_error_hint_node_builtin'));
            }
            return;
        }
