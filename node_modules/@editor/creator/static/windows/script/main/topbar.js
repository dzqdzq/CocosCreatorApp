...
exports.init = function() {
    vm =  new Vue({
        ...
        mounted() {
            if (process.platform === 'darwin') {
                this.barStyle = '-webkit-app-region: drag;';
                this.leftStyle = 'padding-left: 60px;';
            }
...
exports.showCustomHeader = function(src) {
    ...
    const custom = document.querySelector('#custom-toolbar');
    custom.removeAttribute('hidden');

    const customPanel = document.querySelector('#custom-toolbar ui-panel');
