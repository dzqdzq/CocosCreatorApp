...
class QuickCompiler {
    ...
    async buildImportMap(targetIndex, features, configurableFlags) {
        ...
        const moduleOverrides = this._setupModuleOverrides(statsQuery, features, configurableFlags);
    ...
    async _getOrCreateStatsQuery() {
        ...
        const statsQuery = await stats_query_1.StatsQuery.create(this._options.rootDir);
        this._statsQuery = statsQuery;
        return statsQuery;
    }
    _setupModuleOverrides(statsQuery, features, configurableFlags) {
        const mode = 'PREVIEW';
        const platform = 'HTML5';
        const intrinsicFlags = statsQuery.getIntrinsicFlagsOfFeatures(features);
        const buildTimeConstants = (0, build_time_constants_1.setupBuildTimeConstants)({
            mode,
            platform,
            flags: Object.assign(Object.assign(Object.assign({}, intrinsicFlags), configurableFlags), { DEBUG: true }),
        });
