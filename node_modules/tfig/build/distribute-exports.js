        ...
        for (const exportedSymbol of exportSymbols) {
            ...
            if (privateJsDocTag) {
                ...
                if ((exportedSymbol.flags & typescript_1.default.SymbolFlags.Alias) && (originalSymbol.flags & typescript_1.default.SymbolFlags.Module)) {
                    ...
                    const parentNode = (_b = (_a = exportedSymbol.declarations[0]) === null || _a === void 0 ? void 0 : _a.parent) === null || _b === void 0 ? void 0 : _b.parent;
                    if (parentNode) {
                        const tags = typescript_1.default.getJSDocTags(parentNode).map(tag => { return { name: tag.tagName.escapedText }; });
                        if (ts_utils_1.hasJsDocTag(tags, privateJsDocTag)) {
                            continue;
                        }
                    }
                }
                else {
                    if (ts_utils_1.hasJsDocTag(originalSymbol.getJsDocTags(), privateJsDocTag)) {
                        continue;
                    }
                }
            }
