...
class NamespaceTraits extends BaseTraits {
    ...
    transformAliasExports() {
        ...
        const addNamespaceReference = (to) => {
            var _a, _b;
            const resolved = name_resolver_1.resolveRelativePath(this, to.entity);
            const ids = [];
            if (!resolved.module) {
                ids.push(...((_b = (_a = resolved.namespaces) === null || _a === void 0 ? void 0 : _a.slice()) !== null && _b !== void 0 ? _b : []), resolved.name);
            }
            else {
