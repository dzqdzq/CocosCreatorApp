...
function recastTopLevelModule({ program, typeChecker, rModule, nameResolver, exportPrivates, resolveEntity, registerNonExportedSymbol, privateJsDocTag, }) {
    ...
    function recastFunctionDeclaration(functionDeclaration, newName, forceExport) {
        return copyComments(functionDeclaration, nodeFactor.createFunctionDeclaration(undefined, recastModifiers(functionDeclaration.modifiers), functionDeclaration.asteriskToken, newName, recastTypeParameterArray(functionDeclaration.typeParameters), recastParameterArray(functionDeclaration.parameters), // parameters
    ...
    function recastClassDeclaration(classDeclaration, newName, forceExport) {
        ...
        return copyComments(classDeclaration, nodeFactor.createClassDeclaration(undefined, recastDeclarationModifiers(classDeclaration, forceExport), newName, recastTypeParameterArray(classDeclaration.typeParameters), recastHeritageClauses(classDeclaration.heritageClauses), classElements));
    }
    ...
    function recastInterfaceDeclaration(interfaceDeclaration, newName, forceExport) {
        return copyComments(interfaceDeclaration, nodeFactor.createInterfaceDeclaration(undefined, recastDeclarationModifiers(interfaceDeclaration, forceExport), newName, recastTypeParameterArray(interfaceDeclaration.typeParameters), recastHeritageClauses(interfaceDeclaration.heritageClauses), recastTypeElements(interfaceDeclaration.members)));
    }
    ...
    function recastEnumDeclaration(enumDeclaration, newName, forceExport) {
        return copyComments(enumDeclaration, nodeFactor.createEnumDeclaration(undefined, recastDeclarationModifiers(enumDeclaration, forceExport), newName, enumDeclaration.members.map((enumerator) => {
    ...
    function recastTypeAliasDeclaration(typeAliasDeclaration, newName, forceExport) {
        return copyComments(typeAliasDeclaration, nodeFactor.createTypeAliasDeclaration(undefined, recastDeclarationModifiers(typeAliasDeclaration, forceExport), newName, recastTypeParameterArray(typeAliasDeclaration.typeParameters), recastTypeNode(typeAliasDeclaration.type)));
    }
