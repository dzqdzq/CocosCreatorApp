...
function rollupTypes(options) {
    ...
    function bundle() {
        ...
        const exportDistribution = distribute_exports_1.distributeExports(entryModules.map((eM) => eM.symbol), typeChecker, options.priority, options.privateJsDocTag);
        ...
        function getEnclosingModuleName(symbol) {
            ...
            while (true) {
                ...
                if (typescript_1.default.isModuleDeclaration(currentNode) && !(currentNode.flags & typescript_1.default.NodeFlags.Namespace)) {
                    return transformModuleName((_b = (_a = typeChecker.getSymbolAtLocation(currentNode.name)) === null || _a === void 0 ? void 0 : _a.getName()) !== null && _b !== void 0 ? _b : '');
                }
        ...
        function generateIdFromModuleDeclarationName(name) {
        ...
        function generateIdFromSourceFileName(fileName) {
        ...
        function generateIdFromString(text) {
