...
function rollupTypes(options) {
    ...
    function bundle() {
        ...
        const exportDistribution = distribute_exports_1.distributeExports(entryModules.map((eM) => eM.symbol), typeChecker, options.priority);
        ...
        const myRecast = (rModule) => recast_1.recastTopLevelModule({
            program,
            typeChecker,
            rModule,
            nameResolver,
        ...
        function registerNonExportedSymbol(symbol, currentNamespace) {
