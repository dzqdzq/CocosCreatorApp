...
exports.stringifyNode = exports.stringifySymbolFlags = exports.printSymbol = exports.createAccessLink = exports.createEntityName = exports.splitLeftmost = void 0;
...
function createAccessLink(identifiers, leftmost = null) {
    ...
    for (const id of identifiers) {
        ...
        if (!result) {
            ...
            result = typescript_1.default.createPropertyAccess(result, newID);
        }
    }
    return result;
}
