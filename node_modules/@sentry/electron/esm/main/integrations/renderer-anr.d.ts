import { Client, Integration } from '@sentry/core';
 ...
 */
export declare const rendererAnrIntegration: (options?: Options) => RendererAnrIntegration;
/**
 * Creates a hook which notifies the integration when the state of renderers change
 */
export declare function createRendererAnrStatusHandler(client: Client): RendererStatusHandler | undefined;
export {};
//# sourceMappingURL=renderer-anr.d.ts.map