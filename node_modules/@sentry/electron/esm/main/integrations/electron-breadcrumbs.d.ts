 ...
 */
export declare const electronBreadcrumbsIntegration: (userOptions?: Partial<ElectronBreadcrumbsOptions<EventTypes>> | undefined) => import("@sentry/types").IntegrationFnResult;
/**
 * Adds breadcrumbs for Electron events.
 *
 * @deprecated Use `electronBreadcrumbsIntegration()` instead
 */
export declare const ElectronBreadcrumbs: import("@sentry/types").IntegrationClass<import("@sentry/types").Integration>;
export {};
