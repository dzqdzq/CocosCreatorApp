import { defineIntegration, watchdogTimer, logger, stripSentryFramesAndReverse, callFrameToStackFrame, captureEvent } from '@sentry/core';
 ...
 */
const rendererAnrIntegration = defineIntegration((options = {}) => {
    ...
    return {
        ...
        createRendererAnrStatusHandler: () => {
 ...
 */
function createRendererAnrStatusHandler(client) {
    const integration = client.getIntegrationByName(INTEGRATION_NAME);
    return integration?.createRendererAnrStatusHandler();
}

export { createRendererAnrStatusHandler, rendererAnrIntegration };
//# sourceMappingURL=renderer-anr.js.map
