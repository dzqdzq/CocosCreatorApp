import { Attachment } from '@sentry/core';
import { MinidumpParseResult } from './minidump-parser';
/**
 ...
 */
export type MinidumpLoader = (deleteAll: boolean, callback: (minidump: MinidumpParseResult, attachment: Attachment) => Promise<void>) => Promise<void>;
/**
 ...
 */
export declare function createMinidumpLoader(getMinidumpPaths: () => Promise<string[]>): MinidumpLoader;
/**
