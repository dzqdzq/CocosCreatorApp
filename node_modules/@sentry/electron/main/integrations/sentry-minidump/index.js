...
const sentryMinidumpIntegration = core.defineIntegration((options = {}) => {
    ...
    function startCrashReporter() {
        core.logger.log('Starting Electron crashReporter');
    ...
    async function sendNativeCrashes(client, getEvent) {
        ...
        if (minidumpsRemaining <= 0) {
            core.logger.log('Not sending minidumps because the limit has been reached');
        }
    ...
    async function sendRendererCrash(client, options, contents, details) {
        ...
        await sendNativeCrashes(client, (minidumpProcess) => {
            ...
            core.logger.log(`'${crashedProcess}' process '${details.reason}'`);
            return {
                contexts: {
                    electron: {
    ...
    async function sendChildProcessCrash(client, details) {
        core.logger.log(`${details.type} process has ${details.reason}`);
        await sendNativeCrashes(client, (minidumpProcess) => ({
            contexts: {
                electron: { details },
            },
    ...
    return {
        ...
        setup(client) {
            ...
            try {
                ...
                core.logger.error('Failed to create minidump loader', error);
            }
