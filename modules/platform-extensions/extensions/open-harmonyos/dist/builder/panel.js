...
const methods = {
  ...
  async onUpdateOptions(e, a) {
    ...
    if (e) {
      ...
      a = await options_1.verificationFunc(e, a, t.options);
      t.$set(t.pkgErrorMap, e, a.error);
    }
  },
  emitChange() {
    var e = this;
  ...
  async init() {
    ...
    e.apiLevels = await getOHOSAPILevels();

    if (!e.apiLevels.length) {
      e.pkgErrorMap.apiLevels = "i18n:open-harmonyos.tips.apilevel_empty";
      e.emitChange();
    }
  },
};
...
async function getOHOSAPILevels() {
  var e = await Editor.Profile.getConfig("program", "ohos_sdk");
  return e && fs_1.existsSync(e) ? ["7"] : [];
}
exports.$ = { root: ".open-harmonyos" };
