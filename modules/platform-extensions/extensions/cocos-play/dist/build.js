  ...
  "cocos-play": {
    ...
    options: {
      startSceneAssetBundle: {
        label: `i18n:${const_1.PLATFORM_NAME}.options.start_scene_asset_bundle`,
        description: `i18n:${const_1.PLATFORM_NAME}.options.start_scene_asset_bundle_tooltip`,
        default: false,
        render: { ui: "ui-checkbox" },
      },
      deviceOrientation: {
        default: "portrait",
        label: `i18n:${const_1.PLATFORM_NAME}.options.orientation`,
        render: {
          ui: "ui-select",
          items: [
            {
              label: `i18n:${const_1.PLATFORM_NAME}.options.landscape`,
              value: "landscape",
            },
            {
              label: `i18n:${const_1.PLATFORM_NAME}.options.portrait`,
              value: "portrait",
            },
          ],
        },
    ...
    customBuildStages: [
      {
        ...
        displayName: "i18n:cocos-play.make.label",
        requestOptions: true,
