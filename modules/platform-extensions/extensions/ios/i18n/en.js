module.exports = {
  options: {
    ...
    landscape_left_tips:
      "The screen is placed horizontally, with the Home button on the left side of the screen.",
    landscape_right: "Landscape Right",
    landscape_right_tips:
      "The screen is placed horizontally, with the Home button on the right side of the screen.",
    portrait: "Portrait",
    portrait_tips:
      "The screen is placed vertically with the Home button on the bottom.",
  ...
  tips: {
    ...
    version_style_error:
      "The version number format is wrong, please enter the correct version number format, such as 12.0",
    targetVersionError: "Minimum version: 11.0",
    targetVersionErrorWithTaskFlow:
      "When use TaskFlow, the minimun version should be 12.0",
    developerTeamListError:
      "Developer team information not found, select the custom option to fill in",
  ...
  customIcon: { label: "Open the native project with Xcode" },
};
