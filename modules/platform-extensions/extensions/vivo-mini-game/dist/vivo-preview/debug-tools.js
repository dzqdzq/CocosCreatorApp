...
exports.methods = {
  async handleCommand(e) {
    ...
    return !(
      ...
      e !== "run" ||
      !i.rpkPath ||
      (console.debug("rpkPath", `{link(${i.rpkPath})}`),
      await Editor.Panel.open("vivo-mini-game.preview", i.rpkPath),
      Editor.Message.send("vivo-mini-game", "update-rpk-path", i.rpkPath),
      0)
    );
  },
  async getPreviewIp() {
    ...
    e.previewIp = await new Promise((o, t) => {
