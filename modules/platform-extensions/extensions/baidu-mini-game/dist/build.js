...
exports.configs = {
  "baidu-mini-game": {
    ...
    doc: "editor/publish/publish-baidu-mini-game.html",
    options: {
      startSceneAssetBundle: {
        label: "i18n:baidu-mini-game.options.start_scene_asset_bundle",
        description:
          "i18n:bytedance-mini-game.options.start_scene_asset_bundle_tooltip",
        default: false,
      ...
      orientation: {
        ...
        render: {
          ...
          items: [
            {
              label: "i18n:baidu-mini-game.options.landscape",
              value: "landscape",
            },
            {
              label: "i18n:baidu-mini-game.options.portrait",
              value: "portrait",
            },
          ],
        },
    ...
    commonOptions: { useBuiltinServer: { hidden: true } },
    hooks: "./hooks",
