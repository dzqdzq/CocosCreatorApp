module.exports = {
  title: "Xiaomi Quick Game",
  options: {
    package: "App Package Name",
    package_hint:
      "Enter the application package name that formally applied, such as: com.example.demo",
    name: "App Name",
    ...
    version_number_tips:
      "The application version number should be at least +1 than the value of the last submission for review every time it is submitted for review. It is recommended that the version number be recursively +1 for each submission for review",
    ...
    support_min_platform_tips:
      "According to the requirements of Xiaomi Kuai Game, this value must be greater than or equal to 1050",
    ...
    new: "New",
    tools_path: "XiaoMi Pack Tools Directory",
    tips: "Tips",
    pack_tool_use_tip:
      "You can recompile by executing 'npm run build/release' in the XiaoMi Pack Tools directory.",
  ...
  currentPreviewUrl: "Current preview url",
  panelTitle: "XiaoMi Preview Panel",
  tips: {
