...
`,exports.template=(0,fs_extra_1.readFileSync)((0,path_1.join)(__dirname,"../static/view.html"),"utf8"),{data(){return{isNormalVersion:isNormalVersion,pkgOptions:{},wasmConfig:{mode:"wasm",compressMode:""}}},computed:{separateEngineWarningTip(){var e=this;return e.pkgOptions.separateEngine?"wasm"!==e.wasmConfig.mode||e.wasmConfig.compressMode?"i18n:wechatgame.tips.separate_engine_with_wasm":void 0:""}},methods:{t(e){return Editor.I18n.t("wechatgame."+e)},async init(){this.wasmConfig.mode=panel.options.nativeCodeBundleMode,this.wasmConfig.compressMode=panel.options.wasmCompressionMode,this.pkgOptions=panel.options.packages.wechatgame},onChange(t){var a=t.target.getAttribute("path");if(a){let e=t.target.value;void 0!==t.target.value&&null!==t.target.value||(e=t.target.getAttribute("value")),this.$set(this.pkgOptions,a,e),panel.dispatch("update",`packages.${PKG_NAME}.`+a,e,null)}},openProjectSettings(){Editor.Message.send("project","open-settings","engine","modules")}},mounted(){this.init()}});async function update(e,t){switch(panel=this,t){case"nativeCodeBundleMode":panel.vm.wasmConfig.mode=e.nativeCodeBundleMode;break;case"wasmCompressionMode":panel.vm.wasmConfig.compressMode=e.wasmCompressionMode}t&&!t.startsWith("packages."+panel.pkgName)||(panel.options=e,panel.vm.init())}function ready(e){panel=this;var t=require("vue/dist/vue.js");panel.options=e,panel.pkgName=PKG_NAME,panel.vm=new t({el:panel.$.root,...component})}exports.data={vm:null,options:{}},exports.$={root:".wechatgame"};