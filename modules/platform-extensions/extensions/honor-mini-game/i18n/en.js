module.exports = {
  ...
  tips: {
    ...
    project_name_not_legal: "project name not legal",
    private_pem_path_error: "private.pem path is illegal",
    certificate_pem_path_error: "certificate.pem path is illegal",
  ...
  debug_tools: {
    custom_rpk_path: "Custom Rpk Path",
    pack_tool_path: "Pack Tools Path",
    stop_run_server: "Stop server",
    waiting_to_run_server: "Starting to run server, please wait a moment",
    please_rebuild: "Click run again on the build page",
    start_run_server:
      "The service has been started, open Honor Quick Game - Scan Code button, scan to install and debug",
  },
};
