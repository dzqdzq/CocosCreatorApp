...
exports.configs = {
  [share_1.PLATFORM]: {
    ...
    platformType: "ALIPAY",
    doc: "editor/publish/publish-alipay-mini-game.html",
    hooks: "./hooks.js",
    ...
    options: {
      ...
      wasmSubpackage: {
        label: "i18n:alipay-mini-game.options.wasm_subpackage",
        description: "i18n:alipay-mini-game.options.wasm_subpackage_tips",
        render: { ui: "ui-checkbox" },
      },
    },
    commonOptions: { startSceneAssetBundle: { hidden: false } },
    buildTemplateConfig: {
      templates: ["game.json", "game.ejs"].map((e) => ({
