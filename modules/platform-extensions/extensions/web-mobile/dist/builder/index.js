...
exports.Paths = {
  internalTemplateDir: join(
    __dirname,
    "../../../../../../../resources/3d/engine/templates/" + PLATFORM
  ),
};
...
exports.configs = {
  [PLATFORM]: {
    ...
    hooks: "./hooks",
    panel: "./panel",
    icon: { type: "image", value: "../../static/mobile.png" },
      ...
      orientation: {
        ...
        render: {
          ...
          items: [
            ...
            { label: "i18n:web-mobile.options.portrait", value: "portrait" },
            { label: "i18n:web-mobile.options.auto", value: "auto" },
          ],
        },
      },
      embedWebDebugger: {
    ...
    debugConfig: { custom: "./debug-tools" },
    customBuildStages: [
      {
        type: "message",
        name: "run",
        displayName: "i18n:web-mobile.run.label",
        message: { name: "preview", target: "web-mobile" },
        parallelism: "all",
      },
    ],
    buildTemplateConfig: {
