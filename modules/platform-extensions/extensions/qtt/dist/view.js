...
async function ready(t) {
  ...
  i.dispatch("update", "packages." + const_1.PLATFORM_NAME, settings);
  ...
  new (require("vue/dist/vue.js"))({
    ...
    methods: {
      ...
      onChange(t) {
        ...
        i.dispatch(
          "update",
          `packages.${const_1.PLATFORM_NAME}.` + e,
          settings[e]
        );

        verifyData(e, t.value, t);
      },
    },
  });
}
function verifyData(t, e, i) {
  ...
  switch (t) {
    case "versionName": {
      if (e) {
        ...
        exports.platformSettings.versionNameValidity =
          t + " " + Editor.I18n.t("qtt.tips.not_empty");
      }
    ...
    case "package": {
      if (e && /^[a-zA-Z]+[0-9a-zA-Z_]*(\.[a-zA-Z]+[0-9a-zA-Z_]*)*$/.test(e)) {
        o = "";
        exports.platformSettings.packageValidity = "";
      } else {
        exports.platformSettings.packageValidity =
          "" + Editor.I18n.t("qtt.tips.package_name_error");
      }

      break;
    }
    case "icon": {
      if (typeof e == "string" && fs_1.existsSync(e)) {
        o = "";
        exports.platformSettings.iconValidity = "";
      } else {
        exports.platformSettings.iconValidity =
          "Icon Path" + Editor.I18n.t("qtt.tips.icon_not_exist");
      }

      break;
    }
    default: {
      console.debug("verifyData key:", t, e);
      o = "";
    }
  }
  i.style.border = o;
...
async function update(t, e) {
  if (!e || e.startsWith("packages." + const_1.PLATFORM_NAME)) {
