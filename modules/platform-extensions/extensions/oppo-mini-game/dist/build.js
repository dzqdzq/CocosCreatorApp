...
exports.configs = {
  [PLATFORM]: {
    ...
    platformType: "OPPO",
    doc: "editor/publish/publish-oppo-mini-game.html",
    options: {
      package: {
        ...
        verifyRules: ["required", "notNumberFollowDot"],
      },
      icon: {
      ...
      versionCode: {
        ...
        description: "i18n:oppo-mini-game.options.version_number_tips",
        render: {
          ui: "ui-input",
          attributes: {
      ...
      minPlatformVersion: {
        ...
        description: "i18n:oppo-mini-game.options.support_min_platform_tips",
        render: {
          ui: "ui-num-input",
          attributes: {
            placeholder:
      ...
      deviceOrientation: {
        ...
        render: {
          ...
          items: [
            {
              label: "i18n:oppo-mini-game.options.landscape",
              value: "landscape",
            },
            {
              label: "i18n:oppo-mini-game.options.portrait",
              value: "portrait",
            },
          ],
        },
    ...
    customBuildStages: [
      {
        type: "hook",
        name: "make",
        displayName: "i18n:oppo-mini-game.make.label",
        hook: "make",
      },
    ],
    buildTemplateConfig: {
      templates: ["main.ejs", "manifest.json"].map((e) => ({
    ...
    verifyRuleMap: {
      notNumberFollowDot: {
        message:
          "" + Editor.I18n.t("oppo-mini-game.tips.number_follow_dot_error"),
        func(e, i) {
          return !/\.[0-9]/.test(e);
        },
      },
