module.exports = {
  ...
  options: {
    ...
    support_min_platform_tips: "Recommend 1060",
    ...
    new: "New",
    build_sub_package: "Build Sub Package",
  ...
  tips: {
    ...
    number_follow_dot_error: "This option not allow number follow dot(.)",
