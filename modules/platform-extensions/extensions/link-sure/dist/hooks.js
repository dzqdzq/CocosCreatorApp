...
async function onAfterInit(e, t, a) {
  ...
  t = {
    startSceneAssetBundle: t.startSceneAssetBundle,
    orientation: t.deviceOrientation,
...
async function onBeforeBuildAssets(e, t) {
  for (var a of t.bundles) {
    if (a.isSubpackage) {
      a.dest = path_1.default.join(
        path_1.default.dirname(a.dest),
        _SUBPACKAGE_PREFIX + a.name
      );
...
async function onAfterBuild(e, t, a, i) {
  ...
  var e =
    ...
    !fs_extra_1.default.existsSync(path_1.default.join(r, "remote")) ||
      e.server ||
      console.warn(
        _get_string_i18n("options.server") +
          " " +
...
async function make(e, t) {
  ...
  if (fs_1.existsSync(n)) {
    for (var r of fs_1.readdirSync(n)) {
      i.push(r);
      const a = path_1.default.join(
        n,
        t.name + "." + hashes_1.CRC32(r) + ".cpk"
      );
...
function _generate_game_config_json(e, t, a) {
  var t = t.packages[const_1.PLATFORM_NAME];
  ...
  if (t.cameraPermissionHint !== "") {
    n["scope.userLocation"] = t.cameraPermissionHint;
  }
  ...
  if (t.locationPermissionHint !== "") {
    n["scope.userLocation"] = t.locationPermissionHint;
  }

  if (t.albumPermissionHint !== "") {
    n["scope.writePhotosAlbum"] = t.albumPermissionHint;
  }
  ...
  if (fs_extra_1.default.existsSync(t)) {
    n = fs_extra_1.default.readJSONSync(t);
    Object.assign(i, n);
  }

  a = path_1.default.join(e, "game.config.json");
  fs_extra_1.default.writeJSONSync(a, i);
}
