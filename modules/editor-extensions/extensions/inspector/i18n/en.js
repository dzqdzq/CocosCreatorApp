module.exports = {
  ...
  pin: "Pin to inspect the current object properties",
  unpin: "Inspect any selected object",
  locate_asset: "Locate in Assets Panel",
  backward_selection: "Backward Selection",
  forward_selection: "Forward Selection",
  enable_node: "Enable or disable node",
  enable_component: "Enable or disable component",
  menu: {
    node: "Node Menu",
  ...
  asset: {
    reset: "Reset",
    save: "Save",
    prohibitEditInternalAsset: "Prohibit to edit readonly asset.",
    javascript: {
      plugin: "Import As Plugin",
      dependencies: "Dependencies",
      executionScope: "Execution Scope",
      executionScopeGlobal: "Global",
      executionScopeEnclosed: "Enclosed",
    ...
    fbx: {
      ...
      fbx: "FBX",
      GlTFUserData: {
        normals: { name: "Normals", title: "Normals import setting." },
        tangents: { name: "Tangents", title: "Tangents import setting." },
        dumpMaterials: {
          name: "Dump materials",
          title:
            "Whether to extract material assets out of embedded (sub)assets, so that the assets become editable.",
        },
        materialDumpDir: {
      ...
      NormalImportSetting: {
        ...
        exclude: { name: "Exclude", title: "Do not import normals." },
        require: {
          name: "Required",
          title:
            "Import normals that are contained in the model file, or calculated if not contained.",
        },
        recalculate: {
          name: "Recalculate",
          title:
            "Recalculate normals and import, ingoring whether if the model file contain normals.",
        },
      },
      TangentImportSetting: {
        ...
        exclude: { name: "Exclude", title: "Do not import tangents." },
        require: {
          name: "Required",
          title:
        ...
        recalculate: {
          name: "Recalculate",
          title:
            "Recalculate tangents and import, ingoring whether if the model file contain tangents.",
        },
      },
      ImageRemap: { remapAs: "Remap as", original: "Original" },
      limitMaterialDumpDir:
        "The extracted path needs to be scoped to the project path.",
      legacyFbxImporter: {
        name: "Compatible with v1.*",
        title:
          "Whether this importer should be compatible with its behaviour prior to Cocos Creator version 1.* .",
        warn: "Warning: Changing this property may break imported assets that have been using or referencing. ",
      },
      disableMeshSplit: {
        name: "Disable mesh split",
        title:
          "Currently there is a joint-counting-based mesh splitting process during the <br>import pipeline to workaround the max uniform vector limit problem for real-time <br>calculated skeletal animation system on many platforms. This process has a performance <br>impact on other runtime systems too. So if it can be pre-determined that the real-time <br>calculated skeletal animations (when useBakedAnimations is unchecked on SkeletalAnimation <br>component) will not be used, this option can be checked to improve performance. But note that <br> toggling this would update the corresponding prefab, so all the references in the scene should be <br>updated as well to accompany that. To be removed in further refactors.",
      },
      meshOptimizer: {
    ...
    material: { locateEffect: "Locate effect file" },
    erpTextureCube: {
      facesize: {
        name: "",
        facesize:
  ...
  scene: {
    recommendErpTextureCube:
      "For auto generating environment diffuse lighting, Envmap needs to use texture cube image，not CubeMap asset",
  },
  node: {
    layer: {
      confirm_message:
        "Do you want to set layer for all child objects as well?",
      change_children: "Yes, change children",
      change_self: "No, this object only",
    },
  },
  gradient: { title: "Gradient Editor" },
  curve_editor: { title: "Curve Editor" },
  sprite_editor: {
    title: "Sprite Editor",
    scale: "Scale",
    reset: "Reset",
  ...
  check_is_saved: {
    ...
    assetMessage:
      "${assetName} is modified, it's data has not been saved. Do you want to save it?",
    save: "Save",
    abort: "Abort",
  },
  profile: { auto_save: "Auto-save when leaving edit" },
  extension: {
    invalid:
      "The registration type of processing module data is not valid - ${file}",
    register_invalid:
      "The registration type of processing module data is not valid",
    overwritten: "{oldPanel} is overwritten by {panel} from {plugin} ",
  },
};
