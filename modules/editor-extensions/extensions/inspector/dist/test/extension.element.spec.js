        ...
        list: [
            {
                ...
                async handle() {
                    ...
                    const result = element_1.serialize(elem);
        ...
        list: [
            {
                ...
                async handle() {
                    ...
                    const elem = element_1.deserialize(rootString);
