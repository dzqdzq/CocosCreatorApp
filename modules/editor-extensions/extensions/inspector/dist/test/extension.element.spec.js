...
const { serialize, deserialize } = element_1;
    ...
    list: [
      ...
      },
      {
        ...
        async handle() {
          ...
          elem1.addEventListener("a", () => {});
          elem1.addEventListener("b", () => {});
          ...
          const elem1_id = elem1.id;
          elem1.apply(elem2);
          elem1.dispatch("test");
          if (elem1.id !== elem1_id) {
    ...
    list: [
      {
        ...
        async handle() {
          ...
          const elem = deserialize(rootString);
          if (
            elem.tag !== "inspector-root" ||
