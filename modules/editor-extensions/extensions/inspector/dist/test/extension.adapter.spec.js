...
const { decode, encode } = require("../extension/adapter/xml/parser");

const { decode: decode_2 } = require("../extension/adapter/simple-json/parser");
    ...
    list: [
      {
        message: "解析单层 xml",
        async handle() {
          const elem = decode('<div a b="1" c=1 d=true e=0 f=false></div>');
      ...
      },
      {
        message: "解析两层 xml",
        async handle() {
          const elem = decode("<div><span></span></div>");
          if (elem.tag !== "inspector-root") {
            throw new Error("根节点 tag 错误");
          }
      ...
      },
      {
        ...
        async handle() {
          const elem = decode("<ui-label>i18n:aaa</ui-label>");
          if (
      ...
      },
      {
        ...
        async handle() {
          const elem = decode("<div>a<span>b</span>c</div>");
          if (elem.children.length !== 1 || elem.children[0].tag !== "div") {
            throw new Error("children 解析错误");
          }
          if (
      ...
      },
      {
        ...
        async handle() {
          const elem = decode(
            "<div>a<span>b</span>c</div><div>d<span>e</span>f</div>"
          );
          if (
          ...
          if (
            elem.children[0].text !== "ac" ||
            elem.children[1].text !== "df"
          ) {
            throw new Error("单层 child 的 text 解析错误");
          }
          if (
            elem.children[0].children[0].text !== "b" ||
      ...
      },
      {
        ...
        async handle() {
          ...
          // 上一个测试以确保数据正确，这里不再检查
          const elem2 = decode(
            "<div>a<span>b</span>c</div><div>df</div>",
            elem1
          );
          if (elem1 !== elem2) {
            throw new Error("元素出现变化");
      ...
      },
      {
        ...
        async handle() {
          ...
          // 上一个测试以确保数据正确，这里不再检查
          const elem2 = decode(
            "<div>a<span>b</span>c</div><div>d<span>e</span><span>e</span>f</div>",
            elem1
          );
          if (elem1 !== elem2) {
            throw new Error("元素出现变化");
      ...
      },
      {
        ...
        async handle() {
          const elem = decode("<ui-label>i18n:aaa");
          if (
            elem.children.length !== 1 ||
            elem.children[0].tag !== "ui-label"
          ) {
      ...
      },
      {
        ...
        async handle() {
          const elem = decode("<div><ui-label>i18n:aaa</div>");
          if (elem.children.length !== 1 || elem.children[0].tag !== "div") {
      ...
      },
      {
        ...
        async handle() {
          const elem = decode("<div><ui-label>i18n:aaa</ui-label>");
          if (elem.children.length !== 1 || elem.children[0].tag !== "div") {
            throw new Error("解析错误");
          }
          if (elem.children.length !== 1 || elem.children[0].text !== "") {
      ...
      },
      {
        ...
        async handle() {
          const elem = decode("<div><ui-label>i18n:aaa");
          if (elem.children.length !== 1 || elem.children[0].tag !== "div") {
            throw new Error("解析错误");
          }
          if (elem.children.length !== 1 || elem.children[0].text !== "") {
    ...
    list: [
      ...
      },
      {
        ...
        async handle() {
          ...
          if (
            ...
            elem.children[0].children[0].getAttribute("value") !==
              testJSON.label
          ) {
            throw new Error("child 的 children 错误");
          }
      ...
      },
      {
        ...
        async handle() {
          ...
          if (
            elem.children[0].children.length !== 2 ||
            elem.children[0].children[0].tag !== "ui-label" ||
            elem.children[0].children[0].getAttribute("value") !==
              testJSON.label ||
