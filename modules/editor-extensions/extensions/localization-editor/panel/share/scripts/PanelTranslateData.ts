import IWrapperTranslateItemMap from '../../../src/core/entity/translate/IWrapperTranslateItemMap';
import { wrapper } from 'Wrapper';
import { getLanguageDisplayName } from '../scripts/libs/languageMap';
...
export class PanelTranslateData {
    ...
    static async getPanelTranslateData(language?: string): Promise<PanelTranslateData | null> {
        ...
        for (let index = 0; index < items.length; index++) {
            ...
            wrapperTranslateItemMap[item.key] = { ...item, index };
        }
