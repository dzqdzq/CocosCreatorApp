...
import { IDragAdditional, DropCallbackInfo } from './protected';

export * from './protected';
export * from './public';

export { AssetInfo, IRedirectInfo, FileNameCheckConfig } from '@cocos/creator-types/editor/packages/asset-db/@types/protected';
...
export interface IAddInfo {
    ...
    fileNameCheckConfigs?: FileNameCheckConfig[]; // 新建文件可能存在的文件名校验提示机制
}
