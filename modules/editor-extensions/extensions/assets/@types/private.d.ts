import { AssetInfo, IRedirectInfo } from '@editor/library-type/packages/asset-db/@types/public';

export { AssetInfo, IRedirectInfo } from '@editor/library-type/packages/asset-db/@types/public';
...
export interface IAddInfo {
    ...
    type: string; // 类型 directory, js, ts, png 等
