...
async function getFileTree(filePath, root) {
    if (!fs_extra_1.existsSync(filePath))
        return [];
    const names = await fs_extra_1.readdir(filePath);
    const list = await Promise.all(names.map(async (name) => {
        const _path = path_1.join(filePath, name);
        let isDirectory = false;
        try {
            // 有一些特殊文件无法识别，比如快捷图标
            isDirectory = fs_extra_1.statSync(_path).isDirectory();
        }
        catch (error) {
            return undefined;
        }
        ...
        if (isDirectory) {
            const children = (await getFileTree(path_1.join(filePath, name), root)) ?? [];
...
async function getPackageFileExtend(filePath) {
    const dirname = path_1.basename(filePath);
...
function openAssetWithProgram(file, program, args) {
    ...
    if (process.platform === 'darwin') {
        ...
        if (program.endsWith('.app')) {
            program = path_1.join(program, '/Contents/MacOS/');
            const plistObj = plist_1.parse(fs_extra_1.readFileSync(path_1.join(program, '../Info.plist'), 'utf8'));
            program = path_1.join(program, plistObj.CFBundleExecutable);
        }
        if (args) {
...
//# sourceMappingURL=data:application/json;base64,