exports.toolbars = [
  {
    ...
    $: {
      ...
      button: ".reference-image > ui-button",
    },
    ready(e) {
      const r = this;
      const o = r.$.container;
      ...
      r.onShow = (e) => {
        r.showReferenceImage(e);
      };

      r.onConfirm = () => {
        var e = o.classList.toggle("enabled");
        r.showReferenceImage(e);
      ...
      a.addEventListener("click", r.onConfirm);
    ...
    close() {
      var e = this;
      e.$.button.removeEventListener("click", e.onConfirm);
