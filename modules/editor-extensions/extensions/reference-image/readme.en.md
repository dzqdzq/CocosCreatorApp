...
This plugin is designed to facilitate the insertion of reference images in the scene editor, aiding developers in laying out UI elements
...
`referenceImageConfig.images` maintains a common collection of images, and each `prefab` corresponding reference image is recorded in
`referenceImageConfig.sceneUUID`. Based on the current value of `referenceImageConfig.scene`, it can be determined which reference image
