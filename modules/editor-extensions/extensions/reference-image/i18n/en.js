module.exports = {
  ...
  none: "None",
  none_tips: "Click here to add a reference image",
  missing: "(Missing)",
  edit: {
    header: "Image",
    position: "Position",
  ...
  add_image: "add",
  del_image: "delete",
  show_tips: "Whether to display the reference image",
  dialog: {
    add_image_title: "Add reference image",
    del_image_message: "Whether to delete the {path} reference image",
    yes: "Confirm",
    cancel: "Cancel",
  },
  contributions: {
    messages: {
      "add-image": {
        ...
        doc: "- paths {string[]} - Array of absolute paths to reference image resources",
        example: `
      ...
      "remove-image": {
        ...
        doc: "- paths {string[]} - Array of absolute paths to reference image resources (optional); if not provided, remove the current reference image",
        example: `
                await Editor.Message.request('reference-image', 'remove-image', paths);
            `,
      },
      "switch-image": {
        description: "Switch reference image",
        doc: `
      ...
      "set-image-data": {
        description: "Set reference image data",
        doc: `
      ...
      "query-config": {
        description: "Request reference image configuration",
        doc: "@return {IReference}",
        example:
          "await Editor.Message.request('reference-image', 'query-config');",
      },
      "query-current": {
        description: "Request current reference image data",
        doc: "@return {IImageData}",
        example: `
                await Editor.Message.request('reference-image', 'query-current');
            `,
      },
      refresh: {
        description: "Refresh reference image",
        doc: " ",
        example: `
