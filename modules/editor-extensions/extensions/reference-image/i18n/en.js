"use strict";module.exports={name:"Reference Image",description:"Reference Image",none:"None",none_tips:"Click here to add a reference image",missing:"(Missing)",edit:{header:"Image",position:"Position",scale:"Scale",opacity:"Opacity"},add_image:"add",del_image:"delete",show_tips:"Whether to display the reference image",dialog:{add_image_title:"Add reference image",del_image_message:"Whether to delete the {path} reference image",yes:"Confirm",cancel:"Cancel"},contributions:{messages:{"add-image":{description:"Add reference image",doc:"- paths {string[]} - Array of absolute paths to reference image resources",example:`
