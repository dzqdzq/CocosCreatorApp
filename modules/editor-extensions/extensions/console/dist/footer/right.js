...
module.exports = Editor.Panel.define({
  ...
  style: readFileSync(join(__dirname, "../../dist/right.css"), "utf8"),
  $: {
  ...
  methods: {
    ...
    updateCounter(e) {
      this.$.info.innerText = "" + e.info;
      this.$.warn.innerText = "" + e.warn;
      this.$.error.innerText = "" + e.error;
      this.$.iconInfo?.setAttribute("color", e.info ? "true" : "normal");
      this.$.iconWarn?.setAttribute("color", e.warn ? "true" : "normal");
      this.$.iconError?.setAttribute("color", e.error ? "true" : "normal");
    },
  },
  async ready() {
    this.clear = this.clear.bind(this);
    this.updateCounter = this.updateCounter.bind(this);
    var e = this.$.counter?.querySelectorAll(".icon-box");
      ...
      Array.from(e).forEach((e) => {
        e.addEventListener("click", async (e) => {
          ...
          if (await Editor.Panel.has("console")) {
            ...
            Editor.Message.send("console", "refresh", e);
          } else {
