        ...
        const tests = [
            {
                ...
                expected: `我的地址是 <ui-link value="${httpLink}">${httpLink}</ui-link> 项目文件在 <ui-link value="${localPatch}">${localPatch}</ui-link> 然后呢 <ui-link value="${localPatch}">${localPatch}</ui-link>`,
            },
            {
                args: '我只是一个普通的字符串',
