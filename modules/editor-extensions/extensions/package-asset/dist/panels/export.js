"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const fs_1=require("fs"),path_1=require("path"),remote_1=require("@electron/remote"),utlis_1=require("../common/utlis"),JSZip=require("../../lib/jszip.min"),{I18n,Message}=(exports.style=(0,fs_1.readFileSync)((0,path_1.join)(__dirname,"../../css/index.css"),"utf8"),Editor);exports.listeners={resize(){this.$.tree.render(!0)}},exports.template=`
    <header>
        <h1>
