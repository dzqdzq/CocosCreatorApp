...
class LFX_App {
    ...
    Init(data = {}) {
        ...
        // AO半径
        this.Baker.World.Settings.AORadius = data.aoRadius || 1;
        // 线程数量
                ...
                if (this.Baker.Finished) {
                    ...
                    if (file !== null && this.Baker.World.Settings.BakeLightProbe) {
                        ...
                        if (!scene || !scene.globals
                            ...
                            console.error('Missing scene.globals.lightProbeInfo.data.probes');
                        }
                            ...
                            if (file.LightProbeInfos.length === scene.globals.lightProbeInfo.data?.probes.length) {
                                ...
                                console.error('Bake result mismatch with scene.globals.lightProbeInfo.data.probes');
                            }
                        }
                    }
