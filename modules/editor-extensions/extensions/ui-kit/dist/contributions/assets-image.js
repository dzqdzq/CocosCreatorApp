...
class element extends HTMLElement {
  ...
  async resolveValue(e) {
    ...
    var t = (e = e.startsWith("db://")
      ? await Editor.Message.request("asset-db", "query-uuid", e)
      : e)
      .split("@")
      .shift();
    if (Editor.Utils.UUID.isUUID(t)) {
      ...
      if (
        ["image", "texture", "sprite-frame", "gltf-mesh"].includes(t.importer)
      ) {
        this._showImage(e);
      } else {
        this._showIcon(e);
  ...
  _showImage(e) {
    this.$uiImage.setAttribute("value", e);
