...
const { validateBytes, validateString } = require("gltf-validator");
...
async function validateGlTf(e, s) {
  ...
  const i = await (e.endsWith(".glb")
    ? validateBytes(Uint8Array.from(fs_1.default.readFileSync(e)), t)
    : validateString(fs_1.default.readFileSync(e).toString()));
