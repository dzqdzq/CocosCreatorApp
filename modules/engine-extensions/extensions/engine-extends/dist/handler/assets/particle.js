...
exports.ParticleHandler = undefined;
...
async function syncParticleData(a) {
  var a_userData = a.userData;
  var a = plist.parse(await readFile(a.source, "utf8"));
  ...
  var a_userData_startColor =
    ((a_userData_startColor.r = 255 * parseFloat(a.startColorVarianceRed || 0)),
    (a_userData_startColor.g =
      255 * parseFloat(a.startColorVarianceGreen || 0)),
    (a_userData_startColor.b = 255 * parseFloat(a.startColorVarianceBlue || 0)),
  ...
  if (a_userData.emitterMode === EmitterMode.GRAVITY) {
    ...
    a_userData.tangentialAccelVar = parseFloat(a.tangentialAccelVariance || 0);
...
exports.ParticleHandler = {
  ...
  async validate(e) {
    try {
      return (
        plist.parse(await readFile(e.source, "utf8")).maxParticles !== undefined
      );
    } catch (e) {
      return false;
    }
  ...
  importer: {
    ...
    async import(e) {
      ...
      if (!(await e.existsInLibrary(".json")) && e._assetDB) {
        var t = plist.parse(await readFile(e.source, "utf8"));
        await syncParticleData(e);
        var i = createParticle(e);
        ...
        if (t.textureImageData) {
          ...
          var s = basename(t.textureFileName);
          var s = join(dirname(e.source), s);
          e.depend(s);
          var o = e._assetDB.pathToUuid(s);
          if (!existsSync(s)) {
            console.error(
          ...
          s = e._assetDB.getAsset(o);

          s = (await changeImageDefaultType(s, "sprite-frame"), o + "@f9941");
        ...
        t = (await e.saveToLibrary(".json", s), getDependUUIDList(s));
        e.setData("depends", t);
      }
      return true;
    },
