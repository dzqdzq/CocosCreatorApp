...
((t) => {
  ...
  GltfAccessorComponentType ||
    (exports.GltfAccessorComponentType = GltfAccessorComponentType = {})
);
...
((t) => {
  ...
  GltfTextureMagFilter ||
    (exports.GltfTextureMagFilter = GltfTextureMagFilter = {})
);
...
((t) => {
  ...
  GltfTextureMinFilter ||
    (exports.GltfTextureMinFilter = GltfTextureMinFilter = {})
);
...
((t) => {
  ...
  GltfAnimationChannelTargetPath ||
    (exports.GltfAnimationChannelTargetPath = GltfAnimationChannelTargetPath =
      {})
);
...
((t) => {
  ...
  GlTfAnimationInterpolation ||
    (exports.GlTfAnimationInterpolation = GlTfAnimationInterpolation = {})
);
