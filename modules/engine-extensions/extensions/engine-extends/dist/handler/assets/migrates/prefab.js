...
function compareComponentIDProp(e, _, r, n, t, a, o, i) {
  ...
  var I = createTargetOverrideInfo();
  I.propertyPath = e;
  let b = [];
  ...
  I.source = { __id__: r };
  t = createTargetInfo(b);
  I.target = { __id__: l.root.__id__ };
  return { emptyProp: i, targetOverrideInfo: I, sourceInfo: n, targetInfo: t };
}
  ...
  if (totalPrefab.size === 0) {
    for (const t of await Editor.Message.request("asset-db", "query-assets", {
      ...
      if (!totalPrefab.has(t.uuid) && t.file) {
        totalPrefab.set(t.uuid, readJSONSync(t.file));
      }
    }
  }
...
function getTargetOverrideInfoForComponents(r, e, _, n, t, a, o) {
  ...
  for (const m of _) {
    ...
    var I;
    var b = f[m];
    if (b && Array.isArray(b) && b[0] && b[0].__id__) {
      ...
      if (
        ...
        b.__id__ &&
        ((u = [m]),
        (I = { componentID: r, key: m, idx: -1 }),
        (_ = compareComponentIDProp(u, b.__id__, d, c, n, a, l, I)))
      ) {
        o[r] = I.key;
        i.push(_);
      }
...
async function migratePrefab(_) {
    ...
    if (
      ...
      if (!r.includes(n)) {
        ...
        if (t) {
          ...
          try {
            const e_json = readJSONSync(t.library + ".json");
  ...
  for (let e = 0; e < e_json.length; ++e) {
    var b = e_json[e];
    if (b.__type__ === "cc.Node" && b._prefab) {
      var h = b._prefab.__id__;
      var g = e_json[h];
      if (g && g.root && g.asset) {
        ...
        console.warn(
          `Prefab asset missing, name: ${b._name} in the ${a} : ${_.basename}.`
        );
      }
    }
  }
    ...
    if (n) {
      ...
      if ((!_ || !c.has(r)) && e) {
        try {
          ...
          var o;
          var i;
          var f = comparePrefab(t, e_json, d, I);
  ...
  for (const R of l) {
    ...
    var x = e_json.length - 1;

    var x =
      ((R.mountedChildrenInfo.targetInfo = { __id__: x }),
      e_json.push(R.mountedChildrenInfo),
      e_json.length - 1);

    e_json[R.prefabInstanceID].mountedChildren.push({ __id__: x });
  }
  if (i.length > 0) {
    var A = [];
    for (const U of i) {
      var D = U.emptyProp && U.emptyProp.componentID;
      if (D) {
        var D = e_json[D];
      ...
      if (U.sourceInfo) {
        e_json.push(U.sourceInfo);
        D = e_json.length - 1;
        U.targetOverrideInfo.sourceInfo = { __id__: D };
      }

      if (U.targetInfo) {
        e_json.push(U.targetInfo);
        D = e_json.length - 1;
        e_json.length;
        U.targetOverrideInfo.targetInfo = { __id__: D };
      }

      e_json.push(U.targetOverrideInfo);
      D = e_json.length - 1;
      D = (A.push({ __id__: D }), U.emptyProp);
      if (D) {
