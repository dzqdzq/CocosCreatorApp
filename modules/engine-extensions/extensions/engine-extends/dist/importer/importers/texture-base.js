...
function applyTextureBaseAssetUserData(e, t) {
  t.setWrapMode(getWrapMode(e.wrapModeS), getWrapMode(e.wrapModeT));
  t.setFilters(getFilter(e.minfilter), getFilter(e.magfilter));
  t.setMipFilter(getFilter(e.mipfilter));
  t.setAnisotropy(e.anisotropy);
}
async function migrateAnisotropy(e) {
  e = e.userData;
...
exports.migrateAnisotropy = undefined;
exports.applyTextureBaseAssetUserData = undefined;
exports.getFilterString = undefined;
exports.getFilter = undefined;
exports.getWrapModeString = undefined;
exports.getWrapMode = undefined;
exports.makeDefaultSpriteFrameBaseAssetUserData = undefined;
exports.makeDefaultTextureBaseAssetUserData = undefined;
exports.defaultWrapModeT = undefined;
exports.defaultWrapModeS = undefined;
exports.defaultMipFilter = undefined;
exports.defaultMagFilter = undefined;
exports.defaultMinFilter = undefined;
...
exports.makeDefaultTextureBaseAssetUserData =
  makeDefaultTextureBaseAssetUserData;
exports.makeDefaultSpriteFrameBaseAssetUserData =
