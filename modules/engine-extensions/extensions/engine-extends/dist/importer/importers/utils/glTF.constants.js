...
function getGltfAccessorTypeComponents(t) {
  switch (t) {
    ...
    default: {
      throw new Error(`Unrecognized attribute type: ${t}.`);
    }
  }
}
Object.defineProperty(exports, "__esModule", { value: true });

exports.GlTfAnimationInterpolation = undefined;
exports.GltfAnimationChannelTargetPath = undefined;
exports.GltfWrapMode = undefined;
exports.GltfTextureMinFilter = undefined;
exports.GltfTextureMagFilter = undefined;
exports.GltfPrimitiveMode = undefined;
exports.getGltfAccessorTypeComponents = undefined;
exports.GltfAccessorType = undefined;
exports.GltfAccessorComponentType = undefined;
...
((t) => {
  ...
  (GltfAccessorComponentType =
    exports.GltfAccessorComponentType ||
    (exports.GltfAccessorComponentType = {}))
);
...
((t) => {
  ...
  t[(t.__DEFAULT = 4)] = "__DEFAULT";
})(
  (GltfPrimitiveMode =
    exports.GltfPrimitiveMode || (exports.GltfPrimitiveMode = {}))
);
...
((t) => {
  ...
  (GltfTextureMagFilter =
    exports.GltfTextureMagFilter || (exports.GltfTextureMagFilter = {}))
);
...
((t) => {
  ...
  (GltfTextureMinFilter =
    exports.GltfTextureMinFilter || (exports.GltfTextureMinFilter = {}))
);
...
((t) => {
  ...
  (GltfAnimationChannelTargetPath =
    exports.GltfAnimationChannelTargetPath ||
    (exports.GltfAnimationChannelTargetPath = {}))
);
...
((t) => {
  t.STEP = "STEP";
  t.LINEAR = "LINEAR";
  t.CUBIC_SPLINE = "CUBICSPLINE";
})(
  (GlTfAnimationInterpolation =
    exports.GlTfAnimationInterpolation ||
    (exports.GlTfAnimationInterpolation = {}))
);
