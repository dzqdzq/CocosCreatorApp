...
exports.decodeDracoGeometry = undefined;
...
function decodeAttributes(e, t, o) {
  ...
  for (const A of Object.keys(o.attributes)) {
    ...
    var i = components * d;
    var s = t.GetAttributeByUniqueId(e, uniqueId);
    if (s.num_components() !== components) {
      throw new Error(
    ...
    switch (storageConstructor) {
      case Float32Array: {
        ...
        t.GetAttributeFloatForAllPoints(e, s, r);
        break;
      }
      case Int8Array: {
        r = new decoderModule.DracoInt8Array();
        t.GetAttributeInt8ForAllPoints(e, s, r);
        break;
      }
      case Int16Array: {
        r = new decoderModule.DracoInt16Array();
        t.GetAttributeInt16ForAllPoints(e, s, r);
        break;
      }
      case Int32Array: {
        r = new decoderModule.DracoInt32Array();
        t.GetAttributeInt32ForAllPoints(e, s, r);
        break;
      }
      case Uint8Array: {
        r = new decoderModule.DracoUInt8Array();
        t.GetAttributeUInt8ForAllPoints(e, s, r);
        break;
      }
      case Uint16Array: {
        r = new decoderModule.DracoUInt16Array();
        t.GetAttributeUInt16ForAllPoints(e, s, r);
        break;
      }
      case Uint32Array: {
        r = new decoderModule.DracoUInt32Array();
        t.GetAttributeUInt32ForAllPoints(e, s, r);
        break;
      }
      default: {
    ...
    var l = new storageConstructor(i);
    for (let e = 0; e < i; ++e) {
      l[e] = r.GetValue(e);
    }
    n[A] = l;
