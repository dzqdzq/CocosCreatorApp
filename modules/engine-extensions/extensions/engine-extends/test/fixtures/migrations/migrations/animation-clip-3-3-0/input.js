...
cce.Utils.serialize(
    /** @param {import('cc')} cc */ ((cc) => {
        const animationClip = new cc.AnimationClip();
        animationClip.keys = [[], [0.1], [0.1, 0.2], [0.1, 0.2, 0.3], [0.1, 0.2, 0.3, 0.4]];
        const [
            EMPTY_COMMON_TARGET,
            VEC2_COMMON_TARGET,
            VEC3_COMMON_TARGET,
        ...
        animationClip.curves = [
            ...
            // Composed path
            {
                modifiers: [new cc.animation.HierarchyPath('child'), new cc.animation.ComponentPath('cc.MeshRenderer'), 'materials', 0],
                valueAdapter: (() => {
                    const vp = new cc.animation.UniformProxyFactory();
                    vp.passIndex = 2;
                    vp.uniformName = 'color';
            ...
            {
                modifiers: ['position'],
                data: { keys: 2, values: [new cc.CubicSplineNumberValue(0.1, 0.2, 0.3), new cc.CubicSplineNumberValue(-0.4, 0.5, -0.6)] },
            },
            ...
            // Vec4 curve with cubic interpolation
            {
                ...
                data: {
                    keys: 2,
                    values: [
                        new cc.CubicSplineVec4Value(
                            new cc.Vec4(0.1, 0.2, 0.3, 0.4),
                            new cc.Vec4(0.1, 0.2, 0.3, 0.4),
                            new cc.Vec4(0.1, 0.2, 0.3, 0.4),
                        ),
                        new cc.CubicSplineVec4Value(
            ...
            // Quat curve with cubic interpolation
            {
                ...
                data: {
                    keys: 2,
                    values: [
                        new cc.CubicSplineQuatValue(
                            new cc.Quat(0.1, 0.2, 0.3, 0.4),
                            new cc.Quat(0.1, 0.2, 0.3, 0.4),
                            new cc.Quat(0.1, 0.2, 0.3, 0.4),
                        ),
                        new cc.CubicSplineQuatValue(
            ...
            {
                modifiers: ['x'],
                commonTarget: VEC2_COMMON_TARGET,
                data: { keys: 2, values: [new cc.Vec2(0.1, 0.2), new cc.Vec2(0.3, 0.4)] },
            },
            {
                modifiers: ['y'],
                commonTarget: VEC2_COMMON_TARGET,
            ...
            {
                modifiers: ['x'],
                commonTarget: VEC3_COMMON_TARGET,
                data: { keys: 2, values: [new cc.Vec3(0.1, 0.2, 0.3), new cc.Vec3(0.4, 0.5, 0.6)] },
            },
            {
                modifiers: ['y'],
                commonTarget: VEC3_COMMON_TARGET,
            ...
            {
                modifiers: ['x'],
                commonTarget: VEC4_COMMON_TARGET,
                data: { keys: 2, values: [new cc.Vec4(0.1, 0.2, 0.3, 0.4), new cc.Vec4(0.4, 0.5, 0.6, 0.7)] },
            },

            // Common target with Quat curve
            {
                modifiers: ['y'],
                commonTarget: QUAT_COMMON_TARGET,
                data: { keys: 2, values: [new cc.Quat(0.1, 0.2, 0.3, 0.4), new cc.Quat(0.4, 0.5, 0.6, 0.7)] },
            },

            // Common target with Color curve
            {
                modifiers: ['r'],
                commonTarget: COLOR_COMMON_TARGET,
                data: { keys: 2, values: [new cc.Color(1, 2, 3, 4), new cc.Color(5, 6, 7, 8)] },
            },
            {
                modifiers: ['b'],
                commonTarget: COLOR_COMMON_TARGET,
            ...
            {
                modifiers: ['width'],
                commonTarget: SIZE__COMMON_TARGET,
                data: { keys: 2, values: [new cc.Size(1.0, 2.0), new cc.Size(3.0, 4.0)] },
            },
            {
                modifiers: ['y'],
                commonTarget: SIZE__COMMON_TARGET,
            ...
            {
                modifiers: ['position'],
                data: { keys: 2, values: [new cc.Vec3(0.1, 0.2, 0.3), new cc.Vec3(0.4, 0.5, 0.6)], easingMethod: [0.1, 0.2, 0.3, 0.4] },
            },
            {
                modifiers: ['position'],
                data: {
