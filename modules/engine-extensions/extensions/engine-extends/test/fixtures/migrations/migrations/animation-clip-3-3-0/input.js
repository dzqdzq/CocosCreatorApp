...
cce.Utils.serialize(
  /** @param {import('cc')} cc */ ((cc) => {
    ...
    animationClip.curves = [
      ...
      // Hierarchy path
      {
        modifiers: [new cc.animation.HierarchyPath("child")],
        data: { keys: 0, values: [] },
      },

      // Component path
      {
        modifiers: [new cc.animation.ComponentPath("cc.MeshRenderer")],
        data: { keys: 0, values: [] },
      },
      ...
      // Vec2 curve
      {
        ...
        data: {
          keys: 2,
          values: [new cc.Vec2(0.1, 0.2), new cc.Vec2(0.3, 0.4)],
        },
      },
      ...
      // Color curve
      {
        ...
        data: {
          keys: 2,
          values: [new cc.Color(1, 2, 3, 4), new cc.Color(5, 6, 7, 8)],
        },
      },
      ...
      // Size curve
      {
        ...
        data: {
          keys: 2,
          values: [
            new cc.Size(1 /* 1.0 */, 2 /* 2.0 */),
            new cc.Size(3 /* 3.0 */, 4 /* 4.0 */),
          ],
        },
      },
      ...
      {
        modifiers: ["position"],
        data: { keys: 2, values: [0.1, 0.2], interpolate: false },
      },
      ...
      // Vec3 curve with cubic interpolation
      {
        ...
        data: {
          keys: 2,
          values: [
            new cc.CubicSplineVec3Value(
              new cc.Vec3(0.1, 0.2, 0.3),
              new cc.Vec3(0.1, 0.2, 0.3),
              new cc.Vec3(0.1, 0.2, 0.3)
            ),
            new cc.CubicSplineVec3Value(
      ...
      {
        modifiers: ["x"],
        commonTarget: EMPTY_COMMON_TARGET,
        data: { keys: 0, values: [] },
      },
