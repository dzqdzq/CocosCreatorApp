...
export function createAccessorStuffsFromArrayViews(
...
function getGltfAccessorComponentType(arrayBufferView: IndexedArrayBufferView) {
    switch (arrayBufferView.constructor) {
        case Uint8Array:
            return GltfAccessorComponentType.UNSIGNED_BYTE;
        case Int8Array:
            return GltfAccessorComponentType.BYTE;
        case Uint16Array:
            return GltfAccessorComponentType.UNSIGNED_SHORT;
        case Int16Array:
            return GltfAccessorComponentType.SHORT;
        case Uint32Array:
        ...
        default:
            throw new Error(`${arrayBufferView.constructor.name} is not a glTF component type.`);
    }
}
