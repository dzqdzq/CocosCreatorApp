...
import { GltfAccessorType, GltfAccessorComponentType, getGltfAccessorTypeComponents } from '../../../source/importer/importers/utils/glTF.constants';
...
export class LoadedGlTF {
    ...
    public addAccessor(arrayView: IndexedArrayBufferView, type: GltfAccessorType) {
        ...
        this.glTF.accessors.push({
            ...
            type: type,
            count: buffer.length / getGltfAccessorTypeComponents(type),
        });
